...
#ifdef HB_CUS
U_BOOT_CMD(
    ustar_hb ,    CONFIG_SYS_MAXARGS,    1,     do_ustar_hb,
...
#ifdef HB_CUS
U_BOOT_CMD(
    check_usb_upgrade ,    CONFIG_SYS_MAXARGS,    1,     do_check_usb_upgrade,
    "check_usb_upgrade   - check if there upgrade file exists and do usb upgrade\n",
    "    - \n"
    "    - if there is no upgrade file and upgrade is not set \n"
    "    - it will quit updating \n"
