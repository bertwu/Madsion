...
{
    U32 u32Addr=0;
    #if (ENABLE_MSTAR_NUGGET==1 || ENABLE_MSTAR_NIKE ==1 || ENABLE_MSTAR_MADISON ==1 || ENABLE_MSTAR_MIAMI ==1 || ENABLE_MSTAR_NADAL ==1 || ENABLE_MSTAR_EINSTEIN==1 || ENABLE_MSTAR_NAPOLI==1 || ENABLE_MSTAR_MONACO==1)
