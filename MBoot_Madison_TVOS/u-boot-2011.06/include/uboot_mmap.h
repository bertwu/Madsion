...
#define AES_DECRYPTED_ADDR                    (CONFIG_SYS_MIU0_CACHE|0x3000000)
#define AES_DECRYPTED_LEN                      0x500000 // Len can't smallier than SEGMENT_SIZE
#define RSA_AUTHENTICATION_ADDR               (CONFIG_SYS_MIU0_CACHE|0x3500000)
#define RSA_AUTHENTICATION_LEN                 0x500000// Len can't smallier than SEGMENT_SIZE
#define FILESYSTEM_AUTHENTICATION_BUFFER_ADDR (CONFIG_SYS_MIU0_CACHE|0x4000000)
...
#define LOGO_JPG_DRAM_ADDR      0x05B2C000
    #if(ENABLE_EAGLE==1 || ENABLE_EDISON==1 || ENABLE_EIFFEL==1 || ENABLE_NIKE==1 || ENABLE_MADISON==1  || ENABLE_CLIPPERS==1 || ENABLE_MIAMI==1 || ENABLE_NADAL==1 || ENABLE_EINSTEIN==1 || ENABLE_KAISERIN==1 ||ENABLE_KAISER==1 || ENABLE_EINSTEIN3==1 ENABLE_MONACO==1)
...
#define MMAP_E_DFB_FRAMEBUFFER_ADDR            0x04F33000
