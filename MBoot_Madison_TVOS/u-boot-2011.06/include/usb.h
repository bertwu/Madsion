...
#if defined(CONFIG_URANUS4) || defined(CONFIG_TITANIA8) || defined(CONFIG_TITANIA12) || defined(CONFIG_AMBER2) || \
	defined(CONFIG_JANUS2) || defined(CONFIG_AMBER5) || defined(CONFIG_KAISERIN) || (ENABLE_AMBER3) || \
	(ENABLE_EAGLE) || (ENABLE_AGATE) || (ENABLE_EDISON) || (ENABLE_EIFFEL) || \
	(ENABLE_NIKE) || (ENABLE_NADAL) || (ENABLE_EINSTEIN) || (ENABLE_NIKON) || (ENABLE_EINSTEIN3) || \
	(ENABLE_KAISER) || (ENABLE_MADISON) || (ENABLE_CLIPPERS) || (ENABLE_NAPOLI) || (ENABLE_MIAMI) || (ENABLE_MONACO)
#define ENABLE_THIRD_EHC
#endif

#if defined(CONFIG_KAISERIN) || (ENABLE_EINSTEIN) || (ENABLE_EINSTEIN3) || (ENABLE_NAPOLI) || (ENABLE_MONACO)
...
#if (ENABLE_NIKE) || (ENABLE_NADAL) || (ENABLE_MADISON) || (ENABLE_MIAMI)
#define ENABLE_XHC
#endif
