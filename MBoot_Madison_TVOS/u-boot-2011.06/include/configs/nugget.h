...
#include "../../../sboot/inc/nugget/board/Board.h"
...
#if CONFIG_MINIUBOOT
#define CONFIG_ENV_ADDR		    CONFIG_UBOOT_ENV_OFFSET
#define CONFIG_ENV_ADDR_BAK     CONFIG_UBOOT_ENV_BK_OFFSET
#else
#define CONFIG_ENV_ADDR		    cfg_env_offset
#define CONFIG_ENV_ADDR_BAK        (CONFIG_ENV_ADDR + CONFIG_ENV_SIZE)
#endif //CONFIG_MINIUBOOT
...
#define CONFIG_SYS_PROMPT		"nugget# "
...
//#define CONFIG_STR_CRC
#define CONFIG_STR_CRC 0
