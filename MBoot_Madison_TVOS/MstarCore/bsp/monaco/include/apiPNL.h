...
// more SSC OSD function, shall be added into XC_PNL_OBJ
APIPNL_Result       MApi_PNL_SetOSDSSC_En(MS_BOOL bEnable);

//------------------------------------------------------------------------------
/// Set panel OSD SSC Fmodulation
/// @param u16Fmodulation              \b IN:Fmodulation, Unit:0.1Khz
/// @return TRUE --OK   FALSE
//------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------
/// Enable Internal Termination for Urania, disable it for others case
