...
//=============================================================================
    ...
    #define REG_INT_BASE_ADDR               0x0040
#endif
...
//  #define FIQ_RESERVED                    (0x01 << (E_FIQ_03 - E_FIQL_START))
    ...
    #define FIQ_USB                         (0x01 << (E_FIQ_08 - E_FIQL_START))
    #define FIQ_USC                         (0x01 << (E_FIQ_09 - E_FIQL_START))
//  #define FIQ_RESERVED                    (0x01 << (E_FIQ_10 - E_FIQL_START))
    ...
    #define FIQ_UHC2                        (0x01 << (E_FIQ_25 - E_FIQH_START))
    #define FIQ_U3_DPHY                     (0x01 << (E_FIQ_26 - E_FIQH_START))
    ...
    #define FIQ_USB2                        (0x01 << (E_FIQ_30 - E_FIQH_START))
...
//  #define FIQEXPL_RESERVED                (0x01 << (E_FIQ_35 - E_FIQH_START))
    #define FIQEXPL_8051_TO_MIPS_VPE1       (0x01 << (E_FIQ_36 - E_FIQEXPL_START))
    #define FIQEXPL_8051_TO_BEON            (0x01 << (E_FIQ_37 - E_FIQEXPL_START))
    #define FIQEXPL_8051_TO_AEON            (0x01 << (E_FIQ_38 - E_FIQEXPL_START))
    #define FIQEXPL_GPIO0                   (0x01 << (E_FIQ_39 - E_FIQEXPL_START))
    #define FIQEXPL_AEON_TO_MIPS_VPE1       (0x01 << (E_FIQ_40 - E_FIQEXPL_START))
    #define FIQEXPL_AEON_TO_BEON            (0x01 << (E_FIQ_41 - E_FIQEXPL_START))
    #define FIQEXPL_AEON_TO_8051            (0x01 << (E_FIQ_42 - E_FIQEXPL_START))
    #define FIQEXPL_GPIO1                   (0x01 << (E_FIQ_43 - E_FIQEXPL_START))
    #define FIQEXPL_MIPS_VPE0_TO_MIPS_VPE1  (0x01 << (E_FIQ_44 - E_FIQEXPL_START))
    #define FIQEXPL_TIMER2                  (0x01 << (E_FIQ_45 - E_FIQEXPL_START))
    #define FIQEXPL_BEON_TO_8051            (0x01 << (E_FIQ_46 - E_FIQEXPL_START))
    #define FIQEXPL_GPIO2                   (0x01 << (E_FIQ_47 - E_FIQEXPL_START))

    #define FIQEXPH_MASK                    0xFFFF
//  #define FIQEXPH_RESERVED                (0x01 << (E_FIQ_48 - E_FIQEXPH_START))
    #define FIQEXPH_GPIO8                   (0x01 << (E_FIQ_49 - E_FIQEXPH_START))
    #define FIQEXPH_GPIO9                   (0x01 << (E_FIQ_50 - E_FIQEXPH_START))
    #define FIQEXPH_USB1                    (0x01 << (E_FIQ_51 - E_FIQEXPH_START))
    #define FIQEXPH_UHC1                    (0x01 << (E_FIQ_52 - E_FIQEXPH_START))
    #define FIQEXPH_LDM_DMA1                (0x01 << (E_FIQ_53 - E_FIQEXPH_START))
    #define FIQEXPH_LDM_DMA0                (0x01 << (E_FIQ_54 - E_FIQEXPH_START))
    ...
    #define IRQ_USB2                        (0x01 << (E_IRQ_02 - E_IRQL_START))
    ...
    #define IRQ_SDIO                        (0x01 << (E_IRQ_08 - E_IRQL_START))
    #define IRQ_EMAC                        (0x01 << (E_IRQ_09 - E_IRQL_START))
    #define IRQ_DISP                        (0x01 << (E_IRQ_10 - E_IRQL_START))
    #define IRQ_G3D2MCU                     (0x01 << (E_IRQ_11 - E_IRQL_START))
    #define IRQ_MIIC_INT2                   (0x01 << (E_IRQ_12 - E_IRQL_START))
    #define IRQ_MIIC_INT1                   (0x01 << (E_IRQ_13 - E_IRQL_START))
    #define IRQ_COMB                        (0x01 << (E_IRQ_14 - E_IRQL_START))
    #define IRQ_EXT_GPIO0                   (0x01 << (E_IRQ_15 - E_IRQL_START))
    ...
    #define IRQ_MIIC_INT0                   (0x01 << (E_IRQ_22 - E_IRQH_START))
    #define IRQ_MHL_CBUS_PM                 (0x01 << (E_IRQ_23 - E_IRQH_START))
    #define IRQ_GPD                         (0x01 << (E_IRQ_24 - E_IRQH_START))
    #define IRQ_MFE                         (0x01 << (E_IRQ_25 - E_IRQH_START))
    #define IRQ_DDC2BI                      (0x01 << (E_IRQ_26 - E_IRQH_START))
    #define IRQ_SMART                       (0x01 << (E_IRQ_27 - E_IRQH_START))
    #define IRQ_UHC30                       (0x01 << (E_IRQ_28 - E_IRQH_START))
    #define IRQ_MVD2MIPS                    (0x01 << (E_IRQ_29 - E_IRQH_START))
    #define IRQ_ERROR_RESP                  (0x01 << (E_IRQ_30 - E_IRQH_START))
    #define IRQ_ADCDVI2RIU                  (0x01 << (E_IRQ_31 - E_IRQH_START))

    #define IRQEXPL_MASK                    0xFFFF
    #define IRQEXPL_SVD_HVD                 (0x01 << (E_IRQ_32 - E_IRQEXPL_START))
    ...
    #define IRQEXPL_MIU_SECURITY            (0x01 << (E_IRQ_36 - E_IRQEXPL_START))
    #define IRQEXPL_EXT_GPIO2               (0x01 << (E_IRQ_37 - E_IRQEXPL_START))
    #define IRQEXPL_AEON2HI                 (0x01 << (E_IRQ_38 - E_IRQEXPL_START))
    #define IRQEXPL_UART1                   (0x01 << (E_IRQ_39 - E_IRQEXPL_START))
    #define IRQEXPL_PM                      (0x01 << (E_IRQ_40 - E_IRQEXPL_START))
    #define IRQEXPL_EXT_GPIO3               (0x01 << (E_IRQ_41 - E_IRQEXPL_START))
    #define IRQEXPL_DIPW                    (0x01 << (E_IRQ_42 - E_IRQEXPL_START))
    #define IRQEXPL_EXT_GPIO4               (0x01 << (E_IRQ_43 - E_IRQEXPL_START))
    #define IRQEXPL_EVD                     (0x01 << (E_IRQ_44 - E_IRQEXPL_START))
    #define IRQEXPL_JPD                     (0x01 << (E_IRQ_45 - E_IRQEXPL_START))
    #define IRQEXPL_MSPI1                   (0x01 << (E_IRQ_46 - E_IRQEXPL_START))
    #define IRQEXPL_MSPI0                   (0x01 << (E_IRQ_47 - E_IRQEXPL_START))
    ...
    #define IRQEXPH_EXT_GPIO6               (0x01 << (E_IRQ_53 - E_IRQEXPH_START))
    ...
    #define IRQEXPH_UHC2                    (0x01 << (E_IRQ_58 - E_IRQEXPH_START))
    #define IRQEXPH_GE                      (0x01 << (E_IRQ_59 - E_IRQEXPH_START))
    #define IRQEXPH_MIIC_DMA2               (0x01 << (E_IRQ_60 - E_IRQEXPH_START))
    #define IRQEXPH_MIIC_DMA1               (0x01 << (E_IRQ_61 - E_IRQEXPH_START))
    #define IRQEXPH_MIIC_DMA0               (0x01 << (E_IRQ_62 - E_IRQEXPH_START))
    #define IRQEXPH_EXT_GPIO7               (0x01 << (E_IRQ_63 - E_IRQEXPH_START))
