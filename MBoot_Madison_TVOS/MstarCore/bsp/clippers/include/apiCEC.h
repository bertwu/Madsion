...
#define BusFreeTime        6//5 // Free bit time by IC design has a little difference than spec, set to 6 instead of 5
...
//----- Audio Return Channel  Control ------------------
    ...
    E_MSG_ARC_REQUEST_ARC_INITATION             = 0xC3, // should be removed
    E_MSG_ARC_REQUEST_ARC_INITIATION            = 0xC3,

    E_MSG_ARC_REQUEST_ARC_TERMINATION           = 0xC4,

    E_MSG_ARC_TERMINATED_ARC                    = 0xC5, // should be removed
