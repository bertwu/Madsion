...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC DRVURDMA_RESULT MDrv_UrDMA_GetLibVer(const MSIF_Version **ppVersion);
DLL_PUBLIC void MDrv_UrDMA_SetDbgLevel(MS_U8 level);
DLL_PUBLIC DRVURDMA_RESULT MDrv_UrDMA_TxInit(MS_PHYADDR *tx_buf, MS_U16 tx_size);
DLL_PUBLIC DRVURDMA_RESULT MDrv_UrDMA_RxInit(MS_PHYADDR *rx_buf, MS_U16 rx_size);
DLL_PUBLIC DRVURDMA_RESULT MDrv_UrDMA_Polling_Tx_Done(void);
DLL_PUBLIC void MDrv_UrDMA_ISR(void);
DLL_PUBLIC void MDrv_UrDMA_SelMode(URDMA_Mode eMode);
DLL_PUBLIC void MDrv_UrDMA_Engine(MS_BOOL bEnable);
DLL_PUBLIC void MDrv_UrDMA_Init(void *dma_rx_cb, void *dma_tx_cb, URDMA_OPmode eOp_mode);
#ifdef MS_DEBUG
DLL_PUBLIC void MDrv_UrDMA_DumpREG(void);
#endif
