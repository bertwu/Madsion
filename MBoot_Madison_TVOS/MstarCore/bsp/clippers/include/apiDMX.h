...
typedef struct _DMX_FW_Param
{
    ...
    MS_PHYADDR                          phyTSO_VQAddr;
    MS_U32                              u32TSO_VQSize;
...
typedef enum
{
    DMX_CA_PVR_TSP                          = 0x00000000,
    DMX_CA_PVR_PROG0                        = 0x00000001,
    DMX_CA_PVR_PROG1                        = 0x00000002,
}DMX_CA_PVRMODE;
...
typedef enum
{
    ...
    DMX_HW_TYPE_STB_TYPE2        = 0x00002002,       ///< The HW architecture is BOX series with general PVR filters
    DMX_HW_TYPE_STB_TYPE3        = 0x00002003,       ///< The HW architecture is BOX series with PVR CA SPS enable mode
} DMX_HW_TYPE;
...
{
    DMX_PKTMODE_188         = 0x00000000,       ///< DMX file in packet size with 188 (Single stream)
    DMX_PKTMODE_192         = 0x00000001,       ///< DMX file in packet size with 192 (Single stream)
    DMX_PKTMODE_204         = 0x00000002,       ///< DMX file in packet size with 204 (Single stream)
    ...
    DMX_PKTMODE_200         = 0x00000005,       ///< DMX file in packet size with 200 (Open cable Single stream)

    DMX_PKTMODE_MERG188     = 0x00000006,       ///< DMX file in packet size with 188 (Merge stream)
    DMX_PKTMODE_MERG192     = 0x00000007,       ///< DMX file in packet size with 192 (Merge stream)
    DMX_PKTMODE_MERG200     = 0x00000008,       ///< DMX file in packet size with 200 (Open cable Merge stream)
...
DMX_FILTER_STATUS MApi_DMX_Filein_Eng_Start(DMX_FILEIN_PATH ePath, DMX_FILEIN_DST Dst, MS_PHYADDR pBuf, MS_U32 u32BufSize);   // msAPI_DMX_PESPlayback/msAPI_DMX_TSPlayback will integrate into it
