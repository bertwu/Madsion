...
/*Class:     LineDraw/RectFill/Bitblt   */
...
extern GFX_Result MApi_GFX_SetDstMirror(MS_BOOL isMirrorX, MS_BOOL isMirrorY);
...
extern MS_U32     MApi_GFX_SetPowerState(EN_POWER_MODE u16PowerState);
