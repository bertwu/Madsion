...
MS_BOOL MsOS_MPool_UnMapping(MS_U32 u32Offset, MS_U32 u32MapSize);
...
MS_BOOL MsOS_MPool_SetWatchPT(MS_U32 u32Addr, MS_U32 u32ASID, MS_U8 u8Global, MS_U8 u8WType, MS_U32 u32Mask);
...
MS_BOOL MsOS_MEM_GetId(MS_U8* pu8ClientName, MS_U32 u32BufSize, MS_U32* pu32ShmId, MS_U32* pu32Addr, MS_U32* pu32BufSize, MS_U32 u32Flag);
#endif
