...
#define WAIT_ERASE_TIME             (DELAY_1s_in_us<<1)
#define WAIT_WRITE_TIME             (DELAY_1s_in_us<<1)
#define WAIT_READ_TIME              (DELAY_1ms_in_us<<5)  //DELAY_500us_in_us
...
extern U32 nand_translate_DMA_MIU(U32 u32_DMAAddr, U32 u32_ByteCnt);
