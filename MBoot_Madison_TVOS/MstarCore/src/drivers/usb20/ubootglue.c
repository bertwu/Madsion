...
{
	{0, MSTAR_UTMI_BASE,MSTAR_UHC_BASE, MSTAR_USBC_BASE, MSTAR_BC_BASE, MSTAR_INIT_FLAG, 0},
	{1, MSTAR_UTMI1_BASE,MSTAR_UHC1_BASE, MSTAR_USBC1_BASE, MSTAR_BC1_BASE, MSTAR_INIT1_FLAG, 0},
	{2, MSTAR_UTMI2_BASE,MSTAR_UHC2_BASE, MSTAR_USBC2_BASE, MSTAR_BC2_BASE, MSTAR_INIT2_FLAG, 0},
	{3, MSTAR_UTMI3_BASE,MSTAR_UHC3_BASE, MSTAR_USBC3_BASE, MSTAR_BC3_BASE, MSTAR_INIT3_FLAG, 0},
	{4, MSTAR_UTMI4_BASE,MSTAR_UHC4_BASE, MSTAR_USBC4_BASE, MSTAR_BC4_BASE, MSTAR_INIT4_FLAG, 0},
	{5, MSTAR_UTMI5_BASE,MSTAR_UHC5_BASE, MSTAR_USBC5_BASE, MSTAR_BC5_BASE, MSTAR_INIT5_FLAG, 0},
};
