...
#define Host20_Timeout			50		/* 50s Bulk qTD Timeout */
...
#define mwHost20_USBSTS_PeriodicStatus_Rd(a)		(mwHost20Bit_Rd(a,0x14,MS_BIT14))	// Bit 14

// #define mwHost20_USBSTS_Reclamation_Rd()		(mwHost20Bit_Rd(0x14,MS_BIT13))	// Bit 13
// #define mwHost20_USBSTS_HCHalted_Rd()		(mwHost20Bit_Rd(0x14,MS_BIT12))	// Bit 12
...
#define mwHost20_Control_LineStatus_Rd(a)		(mwHost20Port(a,0x40)& MS_BIT11)
#define mwHost20_Control_LineStatus_Set(a)		(mwHost20Bit_Set(a,0x40,MS_BIT11))
#define mwHost20_Control_LineStatus_Clr(a)		(mwHost20Bit_Clr(a,0x40,MS_BIT11))
...
// #define mwHost20_Control_711MA_FS_Issue_Solve()	(mwHost20Bit_Set(0x40,MS_BIT12))	// 0x40 Bit-12
...
extern void		flib_Host20_Issue_Interrupt(struct usb_hcd *hcd, MS_UINT8 *buf, MS_UINT16 hwSize);
