...
void MsDrv_JpdInit(void)
{
    ...
    if(get_addr_from_mmap("E_MMAP_ID_JPD_READ", &u32ReadBuffPA)!=0)
    {
    ...
    if(get_length_from_mmap("E_MMAP_ID_JPD_READ", &u32ReadBuffSize)!=0)
    {
        UBOOT_ERROR("get E_MMAP_ID_JPD_READ mmap fail\n");
    ...
    if(get_addr_from_mmap("E_MMAP_ID_JPD_WRITE", &u32WriteBuffPA)!=0)
    {
    ...
    if(get_length_from_mmap("E_MMAP_ID_JPD_WRITE", &u32WriteBuffSize)!=0)
    {
        UBOOT_ERROR("get E_MMAP_ID_JPD_WRITE mmap fail\n");
        
    }

    if(get_addr_from_mmap("E_MMAP_ID_PHOTO_INTER", &u32InterBuffPA)!=0)
    {
        UBOOT_ERROR("get E_MMAP_ID_PHOTO_INTER mmap fail\n");
        
    }


    if(get_length_from_mmap("E_MMAP_ID_PHOTO_INTER", &u32InterBuffSize)!=0)
    {
        UBOOT_ERROR("get E_MMAP_ID_PHOTO_INTER mmap fail\n");
