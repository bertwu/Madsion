...
#if (ENABLE_EDISON) || (ENABLE_KAISER) || (ENABLE_EINSTEIN) || (ENABLE_NAPOLI) || (ENABLE_KENYA) || (ENABLE_CLIPPERS) || \
	(ENABLE_KERES) || (ENABLE_MONACO)
...
void TV_usb_init_port2(void)
{
...
#if (ENABLE_EDISON) || (ENABLE_KAISER) || (ENABLE_EINSTEIN) || (ENABLE_NAPOLI) || (ENABLE_CLIPPERS) || (ENABLE_MONACO)
	...
	(ENABLE_MADISON) || (ENABLE_MIAMI) || (ENABLE_CLIPPERS) || (ENABLE_MONACO)
