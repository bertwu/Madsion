...
#define BUS_MIU0_BASE_CACHE                 0x20000000      //Beginning cachable bus address of MIU0
#define BUS_MIU0_BASE_NONCACHE              0x40000000      //Beginning non-cachable bus address of MIU0 
