...
void Core_Register_MsInit(void)
{
#if (ENABLE_MSTAR_PUMABOOT)
    // Bring up R2
    Add_Command_Table ("r2pbrun" , 0, STAGE_MSINIT);
    Add_Command_Table ("r2pbdbchan" , 0, STAGE_MSINIT);
    Add_Command_Table ("r2pbdbuser" , 0, STAGE_MSINIT);
    Add_Command_Table ("r2pbpnlinit" , 0, STAGE_MSINIT);
    Add_Command_Table ("r2pbmmap" , 0, STAGE_MSINIT);
    Add_Command_Table ("r2pbinput" , 0, STAGE_MSINIT);
#endif
    ...
    // Bring up R2
    Add_Command_Table ("r2run" , 0, STAGE_MSINIT);
    ...
    Add_Command_Table("get_mboot_config", 0, STAGE_MSINIT);
    #endif

    Add_Command_Table ("updatemiureg" , 0, STAGE_MSINIT);
    
    #if (!(CONFIG_LOGO_STORE_IN_MBOOT) && !(CONFIG_LOGO_STORE_NOT_SET) && !(CONFIG_MINIUBOOT))
