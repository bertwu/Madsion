...
#define BOARD_NAME                              "BD_MST206A_D01A_S_MIAMI"

//=============================================================================
#define PIN_SPI_CZ1                             BALL_C7
#define PIN_SPI_CZ2                             BALL_B7
#define PIN_SPI_CZ3                             0
#define PIN_FLASH_WP0                           BALL_H4
#define PIN_FLASH_WP1                           BALL_F4
...
//=============================================================================
#define BALL_D6_IS_GPIO                         GPIO_OUT_LOW    //Panel (Low: On / High: Off)
#define BALL_E8_IS_GPIO                         GPIO_OUT_LOW    //Backlight (Low: On / High: Off)

#define BALL_V5_IS_GPIO                         GPIO_OUT_HIGH   //Audio (Low: Off / High: On)
#define BALL_E6_IS_GPIO                         GPIO_OUT_LOW    //Mute (Low: Active / High: Mute)
#define BALL_F5_IS_GPIO                         GPIO_OUT_HIGH   //MUTE-POP

#define BALL_A10_IS_GPIO                        GPIO_IN         //DDCR_CK: EEPROM I2C_SCL
#define BALL_C9_IS_GPIO                         GPIO_IN         //DDCR_DA: EEPROM I2C_SDA
#define BALL_AK5_IS_GPIO                        GPIO_IN         //TGPIO2: Tuner I2C_SCL
#define BALL_AM6_IS_GPIO                        GPIO_IN         //TGPIO3: Tuner I2C_SDA

#define BALL_H4_IS_GPIO                         GPIO_OUT_HIGH   //FLASH-WPN1 (SPI_FLASH1 Write Protect)
#define BALL_F4_IS_GPIO                         GPIO_OUT_HIGH   //FLASH-WPN2 (SPI_FLASH2 Write Protect)

#define BALL_G4_IS_GPIO                         GPIO_IN         //MHL-CB-DET
#define BALL_G5_IS_GPIO                         GPIO_OUT_HIGH   //MHL-VBUS-EN

#define BALL_W4_IS_GPIO                         GPIO_OUT_LOW    //PCM_PWR_CTL (Low: Off / High: On)
#define BALL_H6_IS_GPIO                         GPIO_OUT_HIGH   //POWER_SW (Low: Off / High: On)

#define BALL_F8_IS_GPIO                         GPIO_OUT_HIGH   //USB_CTL (Low: Disable / High: Enable)
#define BALL_E7_IS_GPIO                         GPIO_OUT_HIGH   //USB_CTL (Low: Disable / High: Enable)

#define BALL_E4_IS_GPIO                         GPIO_OUT_LOW    //3D_EN_CTL
...
#define CONFIG_SIDD_THRESHOLD_0                 119     //0x0000FFFF: Unused
...
#define CONFIG_OSC_THRESHOLD_0                  121     //0x0000FFFF: Unused
...
#define REG_USB30_GPIO_BANK                     0x101E
#define REG_USB30_GPIO_OFFSET                   0x98 //bit0~bit7 offset addr
#define REG_USB30_GPIO_BIT                      0x5  //bit8~bit10 bit count
#define REG_USB30_GPIO_LOW_ACTIVE               0x1  //Turn on 5V  (0: GPIO High Active / 1: GPIO Low Active)
//=============================================================================

#include "chip/MSD95DOD1W.h"
...
// Audio Amplifier
#define Audio_Amplifier_ON()                    mdrv_gpio_set_high(BALL_V5)
#define Audio_Amplifier_OFF()                   mdrv_gpio_set_low(BALL_V5)

#define Adj_Volume_Off()                        mdrv_gpio_set_high(BALL_E6)
#define Adj_Volume_On()                         mdrv_gpio_set_low(BALL_E6)

//------ PANEL RELATED ---------------------------------------------------------
#define Panel_VCC_ON()                          mdrv_gpio_set_low(BALL_D6)
#define Panel_VCC_OFF()                         mdrv_gpio_set_high(BALL_D6)
#define Panel_Backlight_VCC_ON()                mdrv_gpio_set_low(BALL_E8)
#define Panel_Backlight_VCC_OFF()               mdrv_gpio_set_high(BALL_E8)
...
#define PCMCIA_VCC_ON()                         mdrv_gpio_set_high(BALL_W4)
#define PCMCIA_VCC_OFF()                        mdrv_gpio_set_low(BALL_W4)
