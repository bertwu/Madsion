...
#define BOARD_NAME                              "BD_MST207A_D01A_S_CLIPPERS"

//=============================================================================
#define PIN_SPI_CZ1                             BALL_M22
#define PIN_SPI_CZ2                             0x00
#define PIN_SPI_CZ3                             0x00
//#define PIN_FLASH_WP0                           BALL_AE2
//#define PIN_FLASH_WP1                           BALL_AH6
...
#define PADS_TSO_EVD                            UNKNOWN_PAD_MUX //Option: CONFIG_TSO_EVD_MODE0 / CONFIG_TSO_EVD_MODE1

#if defined(CONFIG_NAND_FLASH)
#define PADS_NAND_MODE                          PAD_NAND_AD     //Option: PAD_PCM_A / PAD_NAND_AD
#define PADS_EMMC_MODE                          UNKNOWN_PAD_MUX //Option: PAD_EMMC
#elif defined(CONFIG_MMC)
#define PADS_NAND_MODE                          UNKNOWN_PAD_MUX //Option: PAD_PCM_A / PAD_NAND_AD
#define PADS_EMMC_MODE                          PAD_EMMC        //Option: PAD_EMMC
#else
#define PADS_NAND_MODE                          UNKNOWN_PAD_MUX //Option: PAD_PCM_A / PAD_NAND_AD
#define PADS_EMMC_MODE                          UNKNOWN_PAD_MUX //Option: PAD_EMMC
#endif
...
#define PADS_I2S_OUT_SD                         UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_I2S_OUT_SD1                        UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_I2S_OUT_SD2                        UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_I2S_OUT_SD3                        UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
...
#define PADS_SPDIF_OUT2                         UNKNOWN_PAD_MUX // 
...
#define PADS_UART5_MODE                         UNKNOWN_PAD_MUX //Option: PAD_GPIO11 / PAD_GPIO12 / PAD_GPIO23 / PAD_GPIO24 / PAD_I2S_OUT_SD2 / PAD_I2S_OUT_SD3
...
#define PADS_OD_UART5_MODE                      UNKNOWN_PAD_MUX //Option: PAD_GPIO11 / PAD_GPIO12 / PAD_GPIO23 / PAD_GPIO24 / PAD_I2S_OUT_SD2 / PAD_I2S_OUT_SD3
...
#define PADS_MIIC_MODE3                         UNKNOWN_PAD_MUX //Option: PAD_GPIO17 / PAD_GPIO18 / PAD_TS1_CLK / PAD_TS1_SYNC
...
#define PADS_TCON8_MODE                         UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_TCON9_MODE                         UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_TCON10_MODE                        UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
...
#define BALL_E18_IS_GPIO                        GPIO_OUT_LOW    //Panel (Low: On / High: Off)
#define BALL_E17_IS_GPIO                        GPIO_OUT_LOW    //Backlight (Low: On / High: Off)

#define BALL_AF4_IS_GPIO                        GPIO_OUT_HIGH   //Audio Class D Amp Mute (Low: On / High: Off)
#define BALL_C15_IS_GPIO                        GPIO_OUT_HIGH   //Audio Amp Enable(Low: Enable / High: Disable)
#define BALL_C14_IS_GPIO                        GPIO_OUT_HIGH   //Audio Mute (Low: Mute / High: On)
#define BALL_F18_IS_GPIO                        GPIO_OUT_HIGH   //Audio Mute (Low: Mute / High: On)

#define BALL_C16_IS_GPIO                        GPIO_IN         //DDCR_CK: EEPROM I2C_SCL
#define BALL_B16_IS_GPIO                        GPIO_IN         //DDCR_DA: EEPROM I2C_SDA
#define BALL_AK5_IS_GPIO                        GPIO_IN         //TGPIO2: Tuner I2C_SCL
#define BALL_AK6_IS_GPIO                        GPIO_IN         //TGPIO3: Tuner I2C_SDA

#define BALL_AE2_IS_GPIO                        GPIO_OUT_HIGH   //FLASH-WPN1 (SPI_FLASH1 Write Protect)
//#define BALL_AH6_IS_GPIO                       GPIO_OUT_HIGH   //FLASH-WPN2 (SPI_FLASH2 Write Protect)

#define BALL_AJ6_IS_GPIO                        GPIO_IN         //MHL-CB-DET
#define BALL_AH5_IS_GPIO                        GPIO_OUT_HIGH   //MHL-VBUS-EN

#define BALL_A16_IS_GPIO                        GPIO_OUT_LOW    //PCM_PWR_CTL (Low: Off / High: On)
#define BALL_J6_IS_GPIO                         GPIO_OUT_LOW    //PCM_PWR_CTL_2 (Low: Off / High: On)
#define BALL_AE3_IS_GPIO                        GPIO_OUT_HIGH   //POWER_SW (Low: Off / High: On)

#define BALL_C18_IS_GPIO                        GPIO_OUT_LOW    //USB3.0 Port0 Power Control (Low: Disable / High: Enable)
#define BALL_B18_IS_GPIO                        GPIO_OUT_LOW    //USB Port1 Power Control (Low: Disable / High: Enable)
#define BALL_A18_IS_GPIO                        GPIO_OUT_HIGH   //USB Port0 Power Control (Low: Disable / High: Enable)
#define BALL_B17_IS_GPIO                        GPIO_OUT_LOW    //USB3.0 Port1 Power Control (Low: Disable / High: Enable)
#define BALL_C17_IS_GPIO                        GPIO_OUT_LOW    //USB Port2 Power Control (Low: Disable / High: Enable)
...
#define CONFIG_VID_THRESHOLD_0                  275     //0x0000FFFF: Unused
...
// Audio Amplifier
#define Audio_Amplifier_ON()                    mdrv_gpio_set_high(1) //please fix it
#define Audio_Amplifier_OFF()                   mdrv_gpio_set_low(1)  //please fix it

#define Adj_Volume_Off()                        mdrv_gpio_set_high(1) //please fix it
#define Adj_Volume_On()                         mdrv_gpio_set_low(1)  //please fix it

//------ PANEL RELATED ---------------------------------------------------------
#define Panel_VCC_ON()                          mdrv_gpio_set_low(BALL_G22)
#define Panel_VCC_OFF()                         mdrv_gpio_set_high(BALL_G22)
#define Panel_Backlight_VCC_ON()                mdrv_gpio_set_low(BALL_G22)  //please fix it
#define Panel_Backlight_VCC_OFF()               mdrv_gpio_set_high(BALL_G22) //please fix it
