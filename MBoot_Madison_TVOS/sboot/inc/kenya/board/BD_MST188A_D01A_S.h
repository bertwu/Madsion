...
#define BOARD_NAME                  "BD_MST188A_D01A_S"


//------Function to PIN mapping (PAD_MUX) --------------------------------------
//#define SUPPORT_TS0  // support external Frontend
...
#define PADS_SPDIF_OUT_MODE         PAD_SPDIF_OUT
...
#define PIN_112_IS_GPIO             GPIO_OUT_HIGH   // Front panel control
#define PIN_113_IS_GPIO             GPIO_OUT_HIGH   // Mute AV in MBoot
//#define PIN_114_IS_GPIO             GPIO_OUT_HIGH   // USB power enable
#define PIN_176_IS_GPIO             GPIO_OUT_HIGH   // EPHY LED Orange
#define PIN_177_IS_GPIO             GPIO_OUT_HIGH   // EPHY LED Green
#ifdef SUPPORT_TS0
#define PIN_180_IS_GPIO             GPIO_OUT_HIGH    // Tuner_PM_CTRL
#endif
#define PIN_199_IS_GPIO             GPIO_OUT_LOW   //Ethernet PHY reset

//------Chip Type---------------------------------------------------------------
#include "chip/MSD7C51G.h"
...
#endif
#define  MIU_INTERFACE                  DDR3_INTERFACE_QFP_216
...
// ----- HDMITX HPD pin --------------------------------------------------------
#define HDMITX_HPD_PM_GPIO          12 // GPIO 0 ~ 12
