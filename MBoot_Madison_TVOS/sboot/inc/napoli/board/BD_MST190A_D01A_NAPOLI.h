...
#define BOARD_NAME                  "BD_MST190A_D01A_NAPOLI"

//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                 0
#define PIN_SPI_CZ2                 BALL_B2
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               0
#define PIN_FLASH_WP1               BALL_N3
...
#define PADS_DDCR_MODE              Unknown_pad_mux // ready
#define PADS_MIIC_MODE              Unknown_pad_mux // ready
#define PADS_TS_OUT                 Unknown_pad_mux // ready


//------GPIO setting(default GPIO pin level) ------------------------------------
//#define BALL_N1_IS_GPIO             GPIO_OUT_LOW            // FLASH-WPN1: SPI_FLASH1 write protect, Low :protect
//#define BALL_M1_IS_GPIO             GPIO_OUT_LOW            // SPI-CS1N: SPI_FLASH1 Chip select, Low :select
#define BALL_AJ3_IS_GPIO             GPIO_NONE                 // I2C-SCL: Type: Out=> H/W I2C_SCL pin
#define BALL_AK2_IS_GPIO             GPIO_NONE                 // I2C-SDA: Type: I/O=> H/W I2C_SDA pin

#define BALL_V3_IS_GPIO             GPIO_OUT_LOW            // USB_POWER_Control
#define BALL_J5_IS_GPIO             GPIO_OUT_LOW            // SD Card Power Enable: Low Enable
#define BALL_C4_IS_GPIO             GPIO_OUT_HIGH            // PreAMP_EN: Type Out: Pre AMP EN High Mute
//#define BALL_AE4_IS_GPIO            GPIO_OUT_HIGH            // FRONT_END_RST: HIGH reset
//#define BALL_AD6_IS_GPIO            GPIO_OUT_LOW            // FRONT_END_PWR_CTL : High enable
#define BALL_N3_IS_GPIO             GPIO_OUT_HIGH           // SPI_FLASH1 write protect Low :protect
#define BALL_D1_IS_GPIO             GPIO_OUT_HIGH           // GMAC Reset => low reset
#define BALL_K3_IS_GPIO             GPIO_OUT_HIGH           // System power on/off Low :off
//#define BALL_A2_IS_GPIO             GPIO_OUT_LOW            // SPI_FLASH1 Chip select Low :select
#define BALL_B2_IS_GPIO             GPIO_OUT_LOW            // SPI_FLASH2 Chip select Low :select
#define BALL_AH29_IS_GPIO           GPIO_OUT_LOW            // Rocket Reset : High Reset
#define PAD_GPIO_PM6_IS_GPIO        GPIO_NONE
...
#define REG_USB30_GPIO_OFFSET                   	0x02 //bit0~bit7 offset addr
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_high( BALL_F3 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( BALL_F3  )

#define Adj_Volume_Off()                _FUNC_NOT_USED()
#define Adj_Volume_On()                 _FUNC_NOT_USED()

#define Panel_VCC_ON()                  _FUNC_NOT_USED()//mdrv_gpio_set_low( BALL_K6 )
#define Panel_VCC_OFF()                 _FUNC_NOT_USED()//mdrv_gpio_set_high( BALL_K6 )
#define Panel_Backlight_VCC_ON()        _FUNC_NOT_USED()//mdrv_gpio_set_low( BALL_K5 )
#define Panel_Backlight_VCC_OFF()       _FUNC_NOT_USED()//mdrv_gpio_set_high( BALL_K5 )
...
#define PCMCIA_VCC_ON()                 mdrv_gpio_set_high( BALL_J4 )
#define PCMCIA_VCC_OFF()                mdrv_gpio_set_low( BALL_J4 )
