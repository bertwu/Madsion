...
#define BOARD_NAME                  "BD_MST189D_D01A_S_NAPOLI"

//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                 BALL_B5
#define PIN_SPI_CZ2                 BALL_B6
#define PIN_SPI_CZ3                 BALL_C6
#define PIN_FLASH_WP0               BALL_P4
#define PIN_FLASH_WP1               BALL_L5
...
#define PADS_SPDIF_OUT2             Unknown_pad_mux // ready
#define PADS_SPDIF_IN               PAD_SPDIF_IN    // ready
#define PADS_I2S_IN                 PAD_I2S_IN_WS   // ready
#define PADS_I2S_MUTE               Unknown_pad_mux // ready
#define PADS_I2S_OUT                SINGLE_CH_I2S_OUT // ready
#define PADS_I2S_OUT_SD             ENABLE          //Option: ENABLE / DISABLE
...
//#define BALL_J5_IS_GPIO             GPIO_IN                 // Power detect
//#define BALL_R6_IS_GPIO             GPIO_IN                 // USB Port 0 Over Current Detect

#define BALL_N6_IS_GPIO             GPIO_OUT_HIGH           // Board 12V Power On/Off H:On
#define BALL_N5_IS_GPIO             GPIO_OUT_LOW            // I2S Audio Mute H:Mute
#define BALL_B4_IS_GPIO             GPIO_OUT_HIGH           // PCM Power Control H:Power enable
#define BALL_A3_IS_GPIO             GPIO_OUT_LOW            // Audio Amp Enable L:Enable
#define BALL_AH22_IS_GPIO           GPIO_OUT_LOW            // Panel Power Enable L:On
#define BALL_AG23_IS_GPIO           GPIO_OUT_LOW            // Audio Mute H:Mute
#define BALL_AH23_IS_GPIO           GPIO_OUT_LOW            // Panel Backlight On/Off H:Off
#define BALL_AG28_IS_GPIO           GPIO_OUT_LOW            // USB  Power Control H:Power Enable Mark-- need check
#define BALL_AH28_IS_GPIO           GPIO_OUT_LOW            // USB  Power Control H:Power Enable
#define BALL_AJ28_IS_GPIO           GPIO_OUT_LOW            // USB  Power Control H:Power Enable
#define BALL_AH28_IS_GPIO           GPIO_OUT_LOW            // USB  Power Control H:Power Enable
#define BALL_AJ27_IS_GPIO           GPIO_OUT_LOW            // USB  Power Control H:Power Enable
#define BALL_AM5_IS_GPIO            GPIO_OUT_HIGH           // RF_AGC_CTRL: High: ATV  Low: DTV
#define BALL_J6_IS_GPIO             GPIO_IN                 // USB Port 4 Over Current Detect
#define BALL_K4_IS_GPIO             GPIO_IN                 // USB Port 1 Over Current Detect
#define BALL_L6_IS_GPIO             GPIO_IN                 // USB Port 2 Over Current Detect
#define BALL_L4_IS_GPIO             GPIO_IN                 // USB Port 3 Over Current Detect
//=============================================================================
...
#define CONFIG_SIDD_THRESHOLD_0                 200     //0x0000FFFF: Unused
...
#define CONFIG_OSC_THRESHOLD_0                  185     //0x0000FFFF: Unused
...
#define REG_USB30_GPIO_BANK                   		0x000F
#define REG_USB30_GPIO_OFFSET                   	0x10 //bit0~bit7 offset addr
#define REG_USB30_GPIO_BIT                   		0x0  //bit8~bit10 bit count
#define REG_USB30_GPIO_LOW_ACTIVE                   0x1  //Turn on 5V  ( 0:  GPIO High   1: GPIO Low) active

//=============================================================================

//------Chip Type---------------------------------------------------------------
#include "chip/MSD818KWD.h"
...
#define INPUT_SV_YMUX               INPUT_PORT_YMUX_CVBS1   //INPUT_PORT_NONE_PORT
#define INPUT_SV_CMUX               INPUT_PORT_CMUX_CVBS0   //INPUT_PORT_NONE_PORT
...
//----------------------------ROCKET AUDIO--------------------------------
#define AUDIO_ROCKER_SPDIF_OUT  1
#define AUDIO_ROCKER_I2S_OUT    2

#define AUDIO_ROCKET_OUTPUT_TYPE       Unknown_pad_mux //AUDIO_ROCKER_I2S_OUT AUDIO_ROCKER_SPDIF_OUT Unknown_pad_mux
...
#define EXT_RF_AGC_ON()                 mdrv_gpio_set_high( BALL_AG3 ) // ATV mode: external RF AGC
#define EXT_RF_AGC_OFF()                mdrv_gpio_set_low( BALL_AG3 )  // DTV mode: internal RF AGC
...
#define MIU_CONFIG                      DDR3_MIU0_32_MIU1_16
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_high( BALL_N5)
#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( BALL_N5  )

#define Adj_Volume_Off()                mdrv_gpio_set_low( BALL_A3  )
#define Adj_Volume_On()                 mdrv_gpio_set_high( BALL_A3 )

#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_AH22 )   // Y9->Y10
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_AH22 )  // Y9->Y10
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_AH23 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_AH23 )
...
#define PCMCIA_VCC_ON()                 mdrv_gpio_set_high( BALL_B4 )
#define PCMCIA_VCC_OFF()                mdrv_gpio_set_low( BALL_B4 )
