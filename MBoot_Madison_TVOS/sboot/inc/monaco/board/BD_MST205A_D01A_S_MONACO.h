...
#define BOARD_NAME                              "BD_MST205A_D01A_S_MONACO"

//=============================================================================
#define PIN_SPI_CZ1                             BALL_E3
#define PIN_SPI_CZ2                             BALL_F2
...
//=============================================================================
#define BALL_E18_IS_GPIO                        GPIO_OUT_HIGH    //Panel (Low: On / High: Off)
#define BALL_E17_IS_GPIO                        GPIO_OUT_HIGH    //Backlight (Low: On / High: Off)
...
#define BALL_B18_IS_GPIO                        GPIO_OUT_HIGH   //USB Port1 Power Control (Low: Disable / High: Enable)
...
#define BALL_C17_IS_GPIO                        GPIO_OUT_HIGH   //USB Port2 Power Control (Low: Disable / High: Enable)
...
#define REG_USB30_GPIO_OFFSET                   0xB0 //bit0~bit7 offset addr
...
#define REG_USB30_PORT2_GPIO_OFFSET             0xB3 //bit0~bit7 offset addr
#define REG_USB30_PORT2_GPIO_BIT                0x0  //bit8~bit10 bit count
//=============================================================================

#include "chip/MSD95C0H.h"
...
//------ PANEL RELATED ---------------------------------------------------------
#define Panel_VCC_ON()                          mdrv_gpio_set_low(BALL_E18)
#define Panel_VCC_OFF()                         mdrv_gpio_set_high(BALL_E18)
#define Panel_Backlight_VCC_ON()                mdrv_gpio_set_low(BALL_E17)
#define Panel_Backlight_VCC_OFF()               mdrv_gpio_set_high(BALL_E17)
