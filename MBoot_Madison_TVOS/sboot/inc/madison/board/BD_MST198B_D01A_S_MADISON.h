...
#define BOARD_NAME                              "BD_MST198B_D01A_S_MADISON"

//=============================================================================
#define PIN_SPI_CZ1                             BALL_A2
#define PIN_SPI_CZ2                             BALL_H6
#define PIN_SPI_CZ3                             0
#define PIN_FLASH_WP0                           BALL_J6
#define PIN_FLASH_WP1                           BALL_J6
...
//=============================================================================
#define BALL_B4_IS_GPIO                         GPIO_OUT_HIGH    //Panel (Low: On / High: Off)
#define BALL_J5_IS_GPIO                         GPIO_OUT_HIGH    //Backlight (Low: On / High: Off)

#define BALL_C4_IS_GPIO                         GPIO_OUT_HIGH   //Audio (Low: Off / High: On)
#define BALL_H5_IS_GPIO                         GPIO_OUT_LOW    //Mute (Low: Active / High: Mute)
//#define BALL_H6_IS_GPIO                       GPIO_OUT_HIGH   //MUTE-POP

#define BALL_AA20_IS_GPIO                       GPIO_IN         //DDCR_CK: EEPROM I2C_SCL
#define BALL_Y20_IS_GPIO                        GPIO_IN         //DDCR_DA: EEPROM I2C_SDA
#define BALL_AE3_IS_GPIO                        GPIO_IN         //TGPIO2: Tuner I2C_SCL
#define BALL_AD2_IS_GPIO                        GPIO_IN         //TGPIO3: Tuner I2C_SDA

#define BALL_J6_IS_GPIO                         GPIO_OUT_HIGH   //FLASH-WPN1 (SPI_FLASH1 Write Protect)
//#define BALL_J6_IS_GPIO                       GPIO_OUT_HIGH   //FLASH-WPN2 (SPI_FLASH2 Write Protect)

#define BALL_J4_IS_GPIO                         GPIO_IN         //MHL-CB-DET
#define BALL_M6_IS_GPIO                         GPIO_OUT_HIGH   //MHL-VBUS-EN

#define BALL_AC21_IS_GPIO                       GPIO_OUT_LOW    //PCM_PWR_CTL (Low: Off / High: On)
#define BALL_F6_IS_GPIO                         GPIO_OUT_HIGH   //POWER_SW (Low: Off / High: On)

#define BALL_AD21_IS_GPIO                       GPIO_OUT_LOW    //USB_CTL (Low: Disable / High: Enable)

#define BALL_Y19_IS_GPIO                        GPIO_OUT_LOW    //SD_VCC_EN (Low: Disable / High: Enable)
#define BALL_Y2_IS_GPIO                         GPIO_OUT_HIGH   //SD_SDIO_WP

#define BALL_AD20_IS_GPIO                       GPIO_OUT_LOW    //3D_EN_CTL
...
// Audio Amplifier
#define Audio_Amplifier_ON()                    mdrv_gpio_set_high(BALL_C4)
#define Audio_Amplifier_OFF()                   mdrv_gpio_set_low(BALL_C4)

#define Adj_Volume_Off()                        mdrv_gpio_set_high(BALL_H5)
#define Adj_Volume_On()                         mdrv_gpio_set_low(BALL_H5)

//------ PANEL RELATED ---------------------------------------------------------
#define Panel_VCC_ON()                          mdrv_gpio_set_low(BALL_B4)
#define Panel_VCC_OFF()                         mdrv_gpio_set_high(BALL_B4)
#define Panel_Backlight_VCC_ON()                mdrv_gpio_set_low(BALL_J5)
#define Panel_Backlight_VCC_OFF()               mdrv_gpio_set_high(BALL_J5)
