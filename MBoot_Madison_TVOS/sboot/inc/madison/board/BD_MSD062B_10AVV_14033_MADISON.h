...
#define BOARD_NAME                              "BD_MSD062B_10AVV_14033_MADISON"
...
//=============================================================================
#define BALL_M6_IS_GPIO                         GPIO_OUT_LOW    //VBL_CTRL (High: Active )
#define BALL_N6_IS_GPIO                         GPIO_OUT_LOW   //Panel-VCC(High: Active )
...
#define BALL_L6_IS_GPIO                         GPIO_OUT_HIGH   //AMP-MUTE (High: mute)
...
#define BALL_J5_IS_GPIO                       GPIO_OUT_LOW    //PM_LED(Low: Disable / High: Enable)
#define BALL_AC5_IS_GPIO                        GPIO_IN         //Detect EMMC/NAND Flash Power T
#define BALL_K2_IS_GPIO                        GPIO_OUT_LOW   //PHY  MAC (Low: Disable / High: Enable)
#define BALL_K3_IS_GPIO                        GPIO_OUT_LOW   //PHY  MAC
...
//------ PANEL RELATED ---------------------------------------------------------
#define Panel_VCC_ON()                          mdrv_gpio_set_high(BALL_N6)
#define Panel_VCC_OFF()                         mdrv_gpio_set_low(BALL_N6)
#define Panel_Backlight_VCC_ON()                mdrv_gpio_set_high(BALL_M6)
#define Panel_Backlight_VCC_OFF()               mdrv_gpio_set_low(BALL_M6)
