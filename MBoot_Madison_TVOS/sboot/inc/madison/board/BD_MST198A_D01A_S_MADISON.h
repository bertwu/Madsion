...
#define BOARD_NAME                              "BD_MST198A_D01A_S_MADISON"

//=============================================================================
#define PIN_SPI_CZ1                             BALL_Y7
#define PIN_SPI_CZ2                             0
#define PIN_SPI_CZ3                             0
#define PIN_FLASH_WP0                           BALL_U3
...
//=============================================================================
#define BALL_F5_IS_GPIO                         GPIO_OUT_LOW    //Panel (Low: On / High: Off)
#define BALL_D4_IS_GPIO                         GPIO_OUT_LOW    //Backlight (Low: On / High: Off)

#define BALL_F4_IS_GPIO                         GPIO_OUT_HIGH   //Audio (Low: Off / High: On)
#define BALL_T2_IS_GPIO                         GPIO_OUT_LOW    //Mute (Low: Active / High: Mute)
//#define BALL_T2_IS_GPIO                       GPIO_OUT_HIGH   //MUTE-POP
...
#define BALL_U3_IS_GPIO                         GPIO_OUT_HIGH   //FLASH-WPN1 (SPI_FLASH1 Write Protect)
//#define BALL_U3_IS_GPIO                       GPIO_OUT_HIGH   //FLASH-WPN2 (SPI_FLASH2 Write Protect)

#define BALL_W2_IS_GPIO                         GPIO_IN         //MHL-CB-DET
//#define BALL_AD5_IS_GPIO                      GPIO_OUT_HIGH   //MHL-VBUS-EN

#define BALL_C2_IS_GPIO                         GPIO_OUT_LOW    //PCM_PWR_CTL (Low: Off / High: On)
#define BALL_N6_IS_GPIO                         GPIO_OUT_HIGH   //POWER_SW (Low: Off / High: On)

#define BALL_P4_IS_GPIO                         GPIO_OUT_LOW    //USB_CTL (Low: Disable / High: Enable)
...
//------ PANEL RELATED ---------------------------------------------------------
#define Panel_VCC_ON()                          mdrv_gpio_set_low(BALL_F5)
#define Panel_VCC_OFF()                         mdrv_gpio_set_high(BALL_F5)
#define Panel_Backlight_VCC_ON()                mdrv_gpio_set_low(BALL_D4)
#define Panel_Backlight_VCC_OFF()               mdrv_gpio_set_high(BALL_D4)
...
#define PCMCIA_VCC_ON()                         mdrv_gpio_set_high(BALL_C2)
#define PCMCIA_VCC_OFF()                        mdrv_gpio_set_low(BALL_C2)
