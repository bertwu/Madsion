...
#define BOARD_NAME                              "BD_MST064B_10AVXM_14065_MADISON"
...
//=============================================================================
#define BALL_J5_IS_GPIO                         GPIO_OUT_LOW    //VBL_CTRL (High: Active )
#define BALL_AC21_IS_GPIO                         GPIO_OUT_LOW   //Panel-VCC(High: Active )
#define BALL_H5_IS_GPIO                         GPIO_OUT_HIGH   //AMP-MUTE (High: mute)
#define BALL_J4_IS_GPIO                        GPIO_IN         //MHL-CB-DET
#define BALL_F6_IS_GPIO                         GPIO_OUT_HIGH   //POWER_SW (Low: Off / High: On)
#define BALL_AD21_IS_GPIO                        GPIO_OUT_LOW    //USB3.0 power control usb3_en(Low: Disable / High: Enable)
#define BALL_AD20_IS_GPIO                        GPIO_OUT_LOW    //3D_EN_CTL
#define BALL_G6_IS_GPIO                       GPIO_OUT_LOW    //PM_LED(Low: Disable / High: Enable)
#define BALL_C8_IS_GPIO                        GPIO_IN         //Detect EMMC/NAND Flash Power T
...
//------ PANEL RELATED ---------------------------------------------------------
#define Panel_VCC_ON()                          mdrv_gpio_set_low(BALL_J5)
#define Panel_VCC_OFF()                         mdrv_gpio_set_high(BALL_J5)
#define Panel_Backlight_VCC_ON()                mdrv_gpio_set_high(BALL_AC21)
#define Panel_Backlight_VCC_OFF()               mdrv_gpio_set_low(BALL_AC21)
...
#define PCMCIA_VCC_ON()                         mdrv_gpio_set_high(BALL_J5)
#define PCMCIA_VCC_OFF()                        mdrv_gpio_set_low(BALL_J5)
