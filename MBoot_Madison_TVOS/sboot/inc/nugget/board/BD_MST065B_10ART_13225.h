...
#define BOARD_NAME                  "BD_MST065B_10ART_13225"

#define PIN_SPI_CZ1                 BALL_F7
...
#define PADS_MSPI_MODE              SPI_PAD2

//------GPIO setting(default GPIO pin level) ??? ------------------------------------
#define BALL_D5_IS_GPIO             GPIO_OUT_LOW    //Audio Amp Enable #Enable: low
#define BALL_AA10_IS_GPIO           GPIO_IN         //MHL cable detect #Cable in: High
#define BALL_W5_IS_GPIO             GPIO_OUT_LOW    //MHL VBUS Enable #Enable: Low
#define BALL_F4_IS_GPIO             GPIO_IN         //Keypad SAR0 in
#define BALL_D4_IS_GPIO             GPIO_OUT_HIGH   //I2S_out_mute #Mute: low
#define BALL_G7_IS_GPIO             GPIO_IN   //ARC DET
#define BALL_G5_IS_GPIO             GPIO_IN         //Keypad SAR3 in
#define BALL_T18_IS_GPIO            GPIO_OUT_LOW    //LCD Backlight control #Off: High
#define BALL_T17_IS_GPIO            GPIO_OUT_LOW    //Panel power on/off #Off: High
#define BALL_U18_IS_GPIO            GPIO_OUT_HIGH   //Panel Backlight Dimming Adjust
#define BALL_K5_IS_GPIO             GPIO_OUT_LOW    //Audio_mute #Mute: high
#define BALL_AA4_IS_GPIO            GPIO_OUT_HIGH   //PCM Power Control #Enable: High
#define BALL_Y2_IS_GPIO             GPIO_IN         //H/W I2C_SCL pin (TUNER)
#define BALL_Y1_IS_GPIO             GPIO_IN         //H/W I2C_SDA pin (TUNER)
#define BALL_K15_IS_GPIO            GPIO_IN         //H/W I2C_SDA pin (EEPROM)
#define BALL_L15_IS_GPIO            GPIO_IN         //H/W I2C_SCL pin (EEPROM)

#define BALL_E8_IS_GPIO            GPIO_OUT_LOW   //Panel power on/off #Off: High
#define BALL_D8_IS_GPIO             GPIO_OUT_LOW   //BackLight on/off #Off: Low
#define BALL_E4_IS_GPIO             GPIO_IN
//------Chip Type---------------------------------------------------------------
#include "chip/MSD8832RKM2.h"
...
#define INPUT_TV_YMUX               INPUT_PORT_YMUX_CVBS2
...
#define Switch_DVI2()               MApi_XC_DVI_SwitchSrc(INPUT_HDMI1_MUX)
#define Switch_DVI3()               MApi_XC_DVI_SwitchSrc(INPUT_HDMI2_MUX)
...
#define FRONTEND_DEMOD_TYPE             MSTAR_MSB1233c_DEMOD//EMBEDDED_DVBT_DEMOD //EMBEDDED_DVBT_DEMOD //ZARLINK_ZL10353_DEMODE
#define FRONTEND_TUNER_TYPE             NXP_TDA18275_TUNER//NUTUNE_FK1602_TUNER //PHILIPS_TDA1316_TUNER //PHILIPS_FQD1216_TUNER
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_high( BALL_D5 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( BALL_D5 )

#define Adj_Volume_Off()                mdrv_gpio_set_high( BALL_K6 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( BALL_K6 )

#define Panel_VCC_ON()                  mdrv_gpio_set_high( BALL_E8 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( BALL_E8 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_high( BALL_D8 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_low( BALL_D8 )
...
#define PCMCIA_VCC_ON()                 mdrv_gpio_set_high( BALL_B8 )
#define PCMCIA_VCC_OFF()                mdrv_gpio_set_low( BALL_B8 )
