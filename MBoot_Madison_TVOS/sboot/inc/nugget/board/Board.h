...
//Nugget
#define BD_MST180A_D01A_S               0x0762
#define BD_MST180B_D01A_S               0x0763
#define BD_MST180C_D01A_S               0x0764
#define BD_MST050B_10ART_13225          0x0765
#define BD_NUGGET_LOADBOARD             0x0766
#define BD_MST180D_D01A_S               0x0767
#define BD_MST065B_10ART_13225    0x0768
#define BD_NUGGET_FPGA                  0x076F
...
#if defined(CONFIG_MSTAR_BD_MST180A_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST180A_D01A_S
#elif defined(CONFIG_MSTAR_BD_MST180B_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST180B_D01A_S
#elif defined(CONFIG_MSTAR_BD_MST180C_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST180C_D01A_S
#elif defined(CONFIG_MSTAR_BD_MST050B_10ART_13225)
    #define MS_BOARD_TYPE_SEL           BD_MST050B_10ART_13225
#elif defined(CONFIG_MSTAR_BD_MST065B_10ART_13225)
    #define MS_BOARD_TYPE_SEL           BD_MST065B_10ART_13225
#elif defined(CONFIG_MSTAR_BD_MST180D_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST180D_D01A_S
#elif defined(CONFIG_MSTAR_BD_NUGGET_LOADBOARD)
    #define MS_BOARD_TYPE_SEL           BD_NUGGET_LOADBOARD
#else
...
// SW feature configure header file
    ...
    #include "BD_MST180A_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST180B_D01A_S)
    #include "BD_MST180B_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST180C_D01A_S)
    #include "BD_MST180C_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST050B_10ART_13225)
    #include "BD_MST050B_10ART_13225.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST180D_D01A_S)
    #include "BD_MST180D_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST065B_10ART_13225)
    #include "BD_MST065B_10ART_13225.h"
#elif (MS_BOARD_TYPE_SEL == BD_NUGGET_LOADBOARD)
    #include "BD_NUGGET_LOADBOARD.h"
#elif (MS_BOARD_TYPE_SEL == BD_NUGGET_FPGA)
    #include "BD_NUGGET_FPGA.h"
#else
