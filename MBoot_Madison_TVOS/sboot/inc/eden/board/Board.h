...
// EDEN
#define BD_MST165A_D01A_S           0x0880
#define BD_MST165A_D01B_S           0x0881
#define BD_MST165B_D01A_S           0x0882
#define BD_MST165C_D01A_S           0x0883
#define BD_MST165C_D01B_S           0x0884
#define BD_MST202A_D01A_S           0x0885

#define BD_MST043B_10ALB_12351      0x0886
#define BD_MST043B_10BLB_12413      0x0887
#define BD_MST042B_10BLU_12423      0x0888
#define BD_MST044B_10BLA_12423      0x0889
#define BD_MST044B_10BLA_12423_32	0x088A
//EDEN2
#define BD_MST165C2_D01B_S          0x088B
...
#if defined (CONFIG_MSTAR_EDEN_BD_MST165A_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST165A_D01A_S
#elif defined (CONFIG_MSTAR_EDEN_BD_MST165A_D01B_S)
    #define MS_BOARD_TYPE_SEL       BD_MST165A_D01B_S    
#elif defined (CONFIG_MSTAR_EDEN_BD_MST165B_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST165B_D01A_S
#elif defined (CONFIG_MSTAR_EDEN_BD_MST165C_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST165C_D01A_S
#elif defined (CONFIG_MSTAR_EDEN_BD_MST165C_D01B_S)
    #define MS_BOARD_TYPE_SEL       BD_MST165C_D01B_S
#elif defined (CONFIG_MSTAR_EDEN_BD_MST202A_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST202A_D01A_S
#elif defined (CONFIG_MSTAR_EDEN_BD_MST043B_10ALB_12351)
    #define MS_BOARD_TYPE_SEL       BD_MST043B_10ALB_12351
#elif defined (CONFIG_MSTAR_EDEN_BD_MST043B_10BLB_12413)
    #define MS_BOARD_TYPE_SEL       BD_MST043B_10BLB_12413
#elif defined (CONFIG_MSTAR_EDEN_BD_MST042B_10BLU_12423)
    #define MS_BOARD_TYPE_SEL       BD_MST042B_10BLU_12423
#elif defined (CONFIG_MSTAR_EDEN_BD_MST044B_10BLA_12423)
    #define MS_BOARD_TYPE_SEL       BD_MST044B_10BLA_12423
#elif defined (CONFIG_MSTAR_EDEN_BD_MST044B_10BLA_12423_32)
    #define MS_BOARD_TYPE_SEL       BD_MST044B_10BLA_12423_32
#elif defined (CONFIG_MSTAR_EDEN_BD_MST165C2_D01B_S)
    #define MS_BOARD_TYPE_SEL       BD_MST165C2_D01B_S
...
// SW feature configure header file
    ...
    #include "bd_fpga.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST165A_D01A_S)
    #include "BD_MST165A_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST165A_D01B_S)
    #include "BD_MST165A_D01B_S.h"    
#elif (MS_BOARD_TYPE_SEL == BD_MST165B_D01A_S)
    #include "BD_MST165B_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST165C_D01A_S)
    #include "BD_MST165C_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST165C_D01B_S)
    #include "BD_MST165C_D01B_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST202A_D01A_S)
    #include "BD_MST202A_D01A_S.h"
...
#elif (MS_BOARD_TYPE_SEL == BD_MST042B_10BLU_12423)
