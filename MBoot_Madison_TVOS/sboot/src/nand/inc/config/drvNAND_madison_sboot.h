...
//******************************************************************************
//<MStar Software>
#ifndef __UNFD_MADISON_SBOOT_H__
#define __UNFD_MADISON_SBOOT_H__
...
#define REG_CHIP_REVISION			(CONFIG_RIU_BASE_ADDRESS + (0x001E02 << 1))
...
#define REG_SDR_BYPASS_MODE                 0x43

#define REG_NAND_MODE                       0x0B
#define REG_NAND_MODE_MASK                  (BIT12|BIT13|BIT14)
#define NAND_MODE1                          (BIT12)
#define NAND_MODE2                          (BIT13)

#define REG_NAND_DQS_EN                     GET_REG_ADDR(CHIPTOP_BASE, 0x0D)           /* 0x101E */
#define REG_NAND_DQS_UL                     GET_REG_ADDR(CHIPTOP_BASE, 0x0E)           /* 0x101E */

#define REG_PCM_D_PE                        GET_REG_ADDR(CHIPTOP_BASE, 0x41)
#define REG_PCM_A_PE                        GET_REG_ADDR(CHIPTOP_BASE, 0x0C)
#define REG_PCM2_CD_N                       GET_REG_ADDR(CHIPTOP_BASE, 0x0B)
#define REG_EMMC_PE                         GET_REG_ADDR(CHIPTOP_BASE, 0x6E)

#define REG_SD_USE_BYPASS                   GET_REG_ADDR(CHIPTOP_BASE, 0x40)

//#define REG_CHIP_CONFIG                     GET_REG_ADDR(PMSLEEP_BASE, 0x1F)
#define REG_CHIP_CONFIG                     GET_REG_ADDR(CHIPTOP_BASE, 0x65)
...
#define REG_DQS_PULL                        GET_REG_ADDR(CHIPTOP_BASE, 0x5D)

#define NC_DQS_PULL_H()                     REG_SET_BITS_UINT16(REG_DQS_PULL, BIT_DQS_PULL_H)
#define NC_DQS_PULL_L()                     REG_CLR_BITS_UINT16(REG_DQS_PULL, BIT_DQS_PULL_H)
...
#define	ENABLE_ROM_DMA_FUNCTION		1
...
#define REG_CLK_NFIE_DIV4_EN                        GET_REG_ADDR(CLKGEN_BASE, 0x65)
#define BIT_CLK_SEL_1X                      BIT14

#define REG_CLK_EMMC                        GET_REG_ADDR(CLKGEN_BASE, 0x31)
...
#define NFIE_CLK_86_25M                     (11<<2)
#define NFIE_CLK_75K                        (12<<2)
...
#define NFIE_CLK4X_345M                     (11<<2)
#define NFIE_CLK4X_300K                     (12<<2)

#define DUTY_CYCLE_PATCH                    0 // 1: to enlarge low width for tREA's worst case of 25ns
#if DUTY_CYCLE_PATCH
#define FCIE3_SW_DEFAULT_CLK                NFIE_CLK_86_25M
...
#endif
#define FCIE3_SW_SLOWEST_CLK                NFIE_CLK_3M
...
#endif /* __UNFD_MADISON_SBOOT_H__ */
