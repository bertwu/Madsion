...
U32 nand_clock_setting(U32 u32ClkParam)
{
   ...
   REG_SET_BITS_UINT16(REG_CLK_NFIE_DIV4_EN, BIT_CLK_SEL_1X);
	...
	#elif defined(CONFIG_MSTAR_MONACO) || defined(CONFIG_MSTAR_MIAMI) || defined(CONFIG_MSTAR_CLIPPERS)
    ...
    #endif  // (ENABLE_NIKE) || defined(CONFIG_MSTAR_MADISON) || defined(CONFIG_MSTAR_MIAMI) || defined(CONFIG_MSTAR_MONACO) || defined(ENABLE_NADAL) || (ENABLE_NUGGET)  || defined(CONFIG_MSTAR_CLIPPERS)
