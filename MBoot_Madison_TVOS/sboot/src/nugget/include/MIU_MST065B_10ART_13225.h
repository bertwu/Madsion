...
#define _MIU_MST065B_10ART_13225_H_
//#define _MIU_4X_MODE

#if (ENABLE_MSTAR_BD_MST065B_10ART_13225)
...
const MS_REG_INIT MIU0_DDR_Init[] =
{
    ...
    _RV32_2(0x101204, 0x0012),      //if I64Mode =0x8b else =0x0b
    _RV32_2(0x101206, 0x0c30),      //refresh cycle=0x50 ,TURN_ON_SCRAMBLE=0x8450
    _RV32_2(0x101208, 0x9c3b),      //reg_tRCD
    ...
    _RV32_2(0x110d4c, 0x1144),
    _RV32_2(0x110d50, 0x1111),
    _RV32_2(0x110d38, 0x0065),
    _RV32_2(0x110d3a, 0x4050),
    ...
    _RV32_2(0x110d00, 0x1239),     //for MIU0 = Emerald package
#else
    _RV32_2(0x110d72, 0x0005),
    _RV32_2(0x110d36, 0x4000),      // mclk1x_clkph_ck0 / input div_1st/loop_div_1st
    _RV32_2(0x110d34, 0x0000),      // loop_div/input_div
    ...
    _RV32_2(0x110d60, 0x0008),
    _RV32_2(0x110d60, 0x2370),
    _RV32_2(0x101228, 0x40d0),     //Pack setting
    _RV32_2(0x10122a, 0x0000),     //Reduce latency setting
    _RV32_2(0x1012d4, 0x0000),     //ratio mode = 1
    _RV32_2(0x110d00, 0x1239),     //for MIU0 = Emerald package
#endif
...
const MS_REG_INIT MIU1_DDR_Init[] =
{
    ...
    _RV32_2(0x100604, 0x0012),      //if I64Mode =0x8b else =0x0b
    _RV32_2(0x100606, 0x0c30),      //refresh cycle=0x50 ,TURN_ON_SCRAMBLE=0x8450
    _RV32_2(0x100608, 0x9c3b),      //reg_tRCD
    ...
    _RV32_2(0x110dbc, 0x0144),
    _RV32_2(0x110dbe, 0x1011),
    _RV32_2(0x110dcc, 0x1144),
    ...
    _RV32_2(0x110d80, 0x0238),     //for MIU1 = Nike package
#else
    _RV32_2(0x110df2, 0x0005),
    _RV32_2(0x110db6, 0x4000),      // mclk1x_clkph_ck0 / input div_1st/loop_div_1st
    _RV32_2(0x110db4, 0x0000),      // loop_div/input_div
    ...
    _RV32_2(0x110de0, 0x0008),
    _RV32_2(0x110de0, 0x2370),
    _RV32_2(0x100628, 0x40d0),     //Pack setting
    _RV32_2(0x10062a, 0x0000),     //Reduce latency setting
    _RV32_2(0x1006d4, 0x0000),     //ratio mode = 1
    _RV32_2(0x110d80, 0x0238),     //for MIU1 = Nike package
#endif
...
#endif  //ENABLE_MSTAR_BD_MST180D_D01A_S

#endif /* _MIU_MST180D_D01A_S_H_ */
