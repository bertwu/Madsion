...
#define _MapBase_nonPM_EDEN 0xA0200000
#define _MapBase_PM_EDEN    0xA0000000
...
#define PAD_GPIO_PM6_OUT (PAD_GPIO_PM6_IS_GPIO == GPIO_OUT_HIGH ? BIT6: 0)
        ...
        #if (MS_BOARD_TYPE_SEL == BD_MST165C2_D01B_S)
        //reg_spi_is_gpio[2]  = 1b
        _RVM1(0x0e6a, 1, BIT2 ),   //reg[0e6a] #2 = 1b ( switch spi_cz1 to gpio_pm[6] (0: spi_cz1, 1: gpio_pm[6]))
        #endif
#endif
...
#define MHL_PORT_MODE  ((PADS_MHL_PORT_CFG == MHL_PORT_MODE_HIGH) ? (BIT4|BIT3) : 0)
...
#if (PIN_FLASH_WP0)
  #if ((MS_BOARD_TYPE_SEL == BD_MST165A_D01A_S) || (MS_BOARD_TYPE_SEL == BD_MST165A_D01B_S))//PAD_PWM0
    _RVM1(0x1e40,    0,  BIT4), //reg[101e40]#4 = 0b
    _RVM1(0x1e85, BIT4,  BIT4), //output high
    _RVM1(0x1e87,    0,  BIT4), //oen: output(0)
  #elif ((MS_BOARD_TYPE_SEL == BD_MST165B_D01A_S)||(MS_BOARD_TYPE_SEL == BD_MST042B_10BLU_12423))//PAD_GPIO3 (optional, default : 0) => been used by Audio_en
    //reg_ddcrmode[3:0] = 0000b
    _RVM1(0x1ef6, 0, BIT3|BIT2|BIT1|BIT0 ), //reg[101ef6]#3 ~#0 = 0000b
    _RVM1(0x1e7a, BIT3, BIT3), //output high
    _RVM1(0x1e7e,    0, BIT3), //oen: output(0)
  #elif ((MS_BOARD_TYPE_SEL == BD_MST165C_D01A_S)||(MS_BOARD_TYPE_SEL == BD_MST165C_D01B_S))//PAD_GPIO10 (optional, default : 0) => been used by PWR
    //reg_ddcrmode[3:0] = 0000b
    _RVM1(0x1ef6, 0, BIT3|BIT2|BIT1|BIT0 ), //reg[101ef6]#3 ~#0 = 0000b
    //reg_parallel_TS_in_Config = 00b
    _RVM1(0x1ef7, 0, BIT5|BIT4 ), //reg[101ef7]#5 ~#4 = 00b
  ...
  #elif ((MS_BOARD_TYPE_SEL == BD_MST202A_D01A_S))//PAD_TCON6
    //reg_tconconfig[6]= 0b
    _RVM1(0x1ef2, 0, BIT6 ),   //reg[101ef2]#6 = 0b
    //reg_parallel_TS_in_Config[1:0] = 00b
    _RVM1(0x1ef7, 0, BIT5|BIT4 ),   //reg[101ef7]#5~#4 = 00b
    ...
    _RVM1(0x1e1c, 0, BIT2|BIT1|BIT0 ),   //reg[101e1c]#2~#0 = 000b
    //gpio output high
    _RVM1(0x1e5e, BIT6, BIT6), //output high
    _RVM1(0x1e60,    0, BIT6), //oen: output(0)
  #elif ((MS_BOARD_TYPE_SEL == BD_MST165C2_D01B_S))//PAD_GPIO11
    //reg_ddcrmode[3:0] = 0000b
    _RVM1(0x1ef6, 0, BIT3|BIT2|BIT1|BIT0 ), //reg[101ef6]#3 ~#0 = 0000b
    //reg_parallel_TS_in_Config = 00b
    _RVM1(0x1ef7, 0, BIT5|BIT4 ), //reg[101ef7]#5 ~#4 = 00b
    //reg_parallel_ts_out_config = 000b
    _RVM1(0x1e1c, 0, BIT2|BIT1|BIT0 ), //reg[101e1c]#2 ~#0 = 000b
    _RVM1(0x1e7b, BIT2, BIT3), //output high
    _RVM1(0x1e7f,    0, BIT3), //oen: output(0)
   #elif ((MS_BOARD_TYPE_SEL == BD_MST043B_10ALB_12351))//PAD_SAR2
   _MEMMAP_PM_,
   _RVM1(0x1422, 0, BIT2 ),   //reg[1422] #2 = 0b
   _RVM1(0x1424, BIT2, BIT2), //output high
   _RVM1(0x1423, 0, BIT2),    //oen: output(0)
   #elif ((MS_BOARD_TYPE_SEL == BD_MST043B_10BLB_12413))//PAD_SAR2
   _MEMMAP_PM_,
   _RVM1(0x1422, 0, BIT2 ),   //reg[1422] #2 = 0b
   _RVM1(0x1424, BIT2, BIT2), //output high
   _RVM1(0x1423, 0, BIT2),    //oen: output(0)
   #elif ((MS_BOARD_TYPE_SEL == BD_MST044B_10BLA_12423))//PAD_SAR2
    _RVM1(0x1e40,    0,  BIT4), //reg[101e40]#4 = 0b
    _RVM1(0x1e85, BIT4,  BIT4), //output high
    _RVM1(0x1e87,    0,  BIT4), //oen: output(0)
   #elif ((MS_BOARD_TYPE_SEL == BD_MST044B_10BLA_12423_32))//PAD_SAR2
    _RVM1(0x1e40,    0,  BIT4), //reg[101e40]#4 = 0b
    _RVM1(0x1e85, BIT4,  BIT4), //output high
    _RVM1(0x1e87,    0,  BIT4), //oen: output(0)
...
void MDrv_Pad_Init( void )
{
    ...
    u32MapBase = _MapBase_nonPM_EDEN;
