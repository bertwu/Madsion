...
//******************************************************************************
//<MStar Software>
#ifndef __eMMC_NIKE_UBOOT__
#define __eMMC_NIKE_UBOOT__
...
#include "../../../../inc/napoli/board/Board.h"
...
#define BIT_reg_test_in_out_mode_mask   (BIT0|BIT1|BIT2|BIT4|BIT5|BIT6)

#define reg_chiptop_0x40       GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x40)
#define BIT_sd_use_bypass       BIT0

#define reg_emmc_rstz_sw        GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x43)
#define BIT_eMMC_RSTPIN_VAL     BIT8

#define reg_emmc_rstz_en        GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x4F)
#define BIT_eMMC_RSTPIN_EN      BIT2
...
#define BIT_CFG_SD_PAD_MASK      (BIT8|BIT9)

#define reg_chiptop_0x64         GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x64)
#define BIT_CFG_PCMCIA_PAD_MASK  (BIT0|BIT3|BIT4)
...
#define CFG_NAND_PAD_MASK        (BIT5|BIT6|BIT7)

#define reg_chiptop_0x7B         GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x7B)
#define CFG_SDIO_PAD_MASK        (BIT5|BIT4)
...
#define eMMC_RST_L()    {REG_FCIE_SETBIT(reg_emmc_rstz_en, BIT_eMMC_RSTPIN_EN);\
	                     REG_FCIE_CLRBIT(reg_emmc_rstz_sw, BIT_eMMC_RSTPIN_VAL);}
#define eMMC_RST_H()    {REG_FCIE_SETBIT(reg_emmc_rstz_en, BIT_eMMC_RSTPIN_EN);\
	                     REG_FCIE_SETBIT(reg_emmc_rstz_sw, BIT_eMMC_RSTPIN_VAL);}	
