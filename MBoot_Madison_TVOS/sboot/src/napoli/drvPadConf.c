...
#define _MapBase_nonPM_NAPOLI      (RIU_MAP + 0x200000)
#define _MapBase_PM_NAPOLI         RIU_MAP
#else
#define _MapBase_nonPM_NAPOLI      0xA0200000
#define _MapBase_PM_NAPOLI         0xA0000000
#endif
...
#define PAD_PWM2_OUT (PAD_PWM2_IS_GPIO == GPIO_OUT_HIGH ? BIT0: 0)
    ...
    //reg_test_out_mode[2:0]
    //_RVM1(0x1e24, 0, BIT6 ~ BIT4 ),   //reg[101e24]#6 ~ #4 = 00b
#if (MS_BOARD_TYPE_SEL == BD_MSD6A801_BTQ_D3C_NAPOLI)
    _RVM1(0x1e24, 0, BIT6|BIT5|BIT4 ),   //reg[101e24]#6 ~ #4 = 00b
#endif
    //reg_pwm2_mode
...
#define SPDIF_OUT2   ((PADS_SPDIF_OUT2 == PAD_I2S_OUT_SD1) ? BIT0 : 0)
        _RVM1(0x1EB3, SPDIF_OUT2, BIT0),
#endif
...
#if (AUDIO_ROCKET_OUTPUT_TYPE != Unknown_pad_mux)
#define AUDIO_MODE      (AUDIO_ROCKET_OUTPUT_TYPE==AUDIO_ROCKER_SPDIF_OUT?0:1)
        _RVM1(0x1E3C, AUDIO_MODE, BIT0),
...
//---------------------------------------------------------------------
    ...
    #if (PIN_FLASH_WP0)
      #if (MS_BOARD_TYPE_SEL == BD_MST189A_D01A_S_NAPOLI)
      // PM13
