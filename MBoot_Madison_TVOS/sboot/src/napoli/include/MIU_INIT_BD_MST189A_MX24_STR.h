...
#ifndef __MIU_INIT_BD_MST189A_MX24_STR_H__
#define __MIU_INIT_BD_MST189A_MX24_STR_H__

#if (ENABLE_MSTAR_NAPOLI_BD_MST189A_MX24)
const MS_REG_INIT MIU0_DDR_Init_STR[] =
{
    ...
    _RV32_2(0x110d3a, 0x0002),  //reg_clkph_cmd         0       : [3:0]
                                //reg_clkph_dqsm        0       : [7:4]
                                //reg_clkph_sp0         0       : [11:8]
                                //reg_clkph_sp1         0       : [15:12]

    _RV32_2(0x110d4a, 0x0002),  //reg_clkph_cmd         0       : [3:0]
                                //reg_clkph_dqsm        0       : [7:4]
                                //reg_clkph_sp0         0       : [11:8]
                                //reg_clkph_sp1         0       : [15:12]

    _RV32_2(0x110d92, 0x0111),// for U02 ECO delay line K/2 + offset
    ...
    _RV32_2(0x110d80, 0xFFFF),
    _RV32_2(0x110d82, 0xFFFF),
    _RV32_2(0x110d84, 0x000F),
    ...
    _RV32_2(0x110da0, 0x3514),  //reg_dll0_3_deskew[3:0],  reg_dll0_2_deskew[3:0], //reg_dll0_1_deskew[3:0],  reg_dll0_0_deskew[3:0]
    _RV32_2(0x110da2, 0x0324),  //reg_dll0_7_deskew[3:0],  reg_dll0_6_deskew[3:0], //reg_dll0_5_deskew[3:0],  reg_dll0_4_deskew[3:0]
    _RV32_2(0x110da4, 0x2032),  //reg_dll0_11_deskew[3:0], reg_dll0_10_deskew[3:0],//reg_dll0_9_deskew[3:0],  reg_dll0_8_deskew[3:0]
    _RV32_2(0x110da6, 0x2131),  //reg_dll0_15_deskew[3:0], reg_dll0_14_deskew[3:0],//reg_dll0_13_deskew[3:0], reg_dll0_12_deskew[3:0]

    //DLL DQ deskew (high word)
    _RV32_2(0x110da8, 0x3405),  //reg_dll1_3_deskew[3:0],  reg_dll1_2_deskew[3:0], //reg_dll1_1_deskew[3:0],  reg_dll1_0_deskew[3:0]
    _RV32_2(0x110daa, 0x1424),  //reg_dll1_7_deskew[3:0],  reg_dll1_6_deskew[3:0], //reg_dll1_5_deskew[3:0],  reg_dll1_4_deskew[3:0]
    _RV32_2(0x110dac, 0x4241),  //reg_dll1_11_deskew[3:0], reg_dll1_10_deskew[3:0],//reg_dll1_9_deskew[3:0],  reg_dll1_8_deskew[3:0]
    _RV32_2(0x110dae, 0x3041),  //reg_dll1_15_deskew[3:0], reg_dll1_14_deskew[3:0],//reg_dll1_13_deskew[3:0], reg_dll1_12_deskew[3:0]
#endif
    //RX DQSx Phase select
    _RV32_2(0x110d70, 0x0000),  //[11]    : 'h   0 : dline_gated_control
    _RV32_2(0x110d6c, 0x1414),  //[ 6: 0] : 'h   f : reg_dll0_ph //[14: 8] : 'h   f : reg_dll1_ph
    _RV32_2(0x110d6e, 0x1313),  //[ 6: 0] : 'h   f : reg_dll2_ph //[14: 8] : 'h   f : reg_dll3_ph
    ...
    _RV32_2(0x110d00, 0x2008),  //reg_pkg_sel      1   : [0]
                                //reg_odt_en       1   : [12:9]
    ...
    _RV32_2(0x110d54, 0xC070),  //cmd_mode_sel = 2'h3
    ...
    _RV32_2(0x101204, 0x0051),  //reg_rd_timing		9	: [4:0] reg_1cmd_mode
    _RV32_2(0x101206, 0x1738),  //tREFRESH		2b	: [7:0] * 16
    _RV32_2(0x101208, 0x24EE),  //reg_tRCD		6	: [3:0]		11.25/1.875= 6
    _RV32_2(0x10120A, 0x3487),  //reg_tRRD	       	4 	: [3:0]	 10/1.875= 6  reg_tRTP(even) = 6
    _RV32_2(0x10120C, 0xC809),  //reg_tWL	 		5	: [3:0]	 CAS latency -1
    _RV32_2(0x10120E, 0xC117),  //tRFC			2a	: [7:0]		127.5/1.875= 68
    ...
    _RV32_2(0x110d4a, 0x0000),  //reg_clkph_cmd         0       : [3:0]
                                //reg_clkph_dqsm        0       : [7:4]
                                //reg_clkph_sp0         0       : [11:8]
                                //reg_clkph_sp1         0       : [15:12]

    _RV32_2(0x110d92, 0x0111),
    _RV32_2(0x110d90, 0x0003),
...
#if 1
    //DLL DQ deskew (low word)
    _RV32_2(0x110da0, 0x0000),  //reg_dll0_3_deskew[3:0],  reg_dll0_2_deskew[3:0], //reg_dll0_1_deskew[3:0],  reg_dll0_0_deskew[3:0]
    _RV32_2(0x110da2, 0x0000),  //reg_dll0_7_deskew[3:0],  reg_dll0_6_deskew[3:0], //reg_dll0_5_deskew[3:0],  reg_dll0_4_deskew[3:0]
    _RV32_2(0x110da4, 0x0000),  //reg_dll0_11_deskew[3:0], reg_dll0_10_deskew[3:0],//reg_dll0_9_deskew[3:0],  reg_dll0_8_deskew[3:0]
    _RV32_2(0x110da6, 0x0000),  //reg_dll0_15_deskew[3:0], reg_dll0_14_deskew[3:0],//reg_dll0_13_deskew[3:0], reg_dll0_12_deskew[3:0]

    //DLL DQ deskew (high word)
    _RV32_2(0x110da8, 0x0000),  //reg_dll1_3_deskew[3:0],  reg_dll1_2_deskew[3:0], //reg_dll1_1_deskew[3:0],  reg_dll1_0_deskew[3:0]
    _RV32_2(0x110daa, 0x0000),  //reg_dll1_7_deskew[3:0],  reg_dll1_6_deskew[3:0], //reg_dll1_5_deskew[3:0],  reg_dll1_4_deskew[3:0]
    _RV32_2(0x110dac, 0x0000),  //reg_dll1_11_deskew[3:0], reg_dll1_10_deskew[3:0],//reg_dll1_9_deskew[3:0],  reg_dll1_8_deskew[3:0]
    _RV32_2(0x110dae, 0x0000),  //reg_dll1_15_deskew[3:0], reg_dll1_14_deskew[3:0],//reg_dll1_13_deskew[3:0], reg_dll1_12_deskew[3:0]
#endif
    //RX DQSx Phase select
    _RV32_2(0x110d70, 0x0000),  //[11]    : 'h   0 : dline_gated_control
    _RV32_2(0x110d6c, 0x1111),  //[ 6: 0] : 'h   f : reg_dll0_ph //[14: 8] : 'h   f : reg_dll1_ph
    _RV32_2(0x110d6e, 0x1111),  //[ 6: 0] : 'h   f : reg_dll2_ph //[14: 8] : 'h   f : reg_dll3_ph
    _RV32_2(0x110d70, 0x0800),  //[11]    : 'h   1 : dline_gated_control
...
const MS_REG_INIT MIU1_DDR_Init_STR[] =
{
    ...
    _RV32_2(0x100602, 0xF3A3),  //reg_dram_type		10	: [1:0]   00 : sdr, 01 : ddr, 10 : ddr2, 11 : ddr3
    ...
    _RV32_2(0x100628, 0x00D0),  //reg_pack_en
    ...
    _RV32_2(0x16163a, 0x0002),  //reg_clkph_cmd         0       : [3:0]
                                //reg_clkph_dqsm        0       : [7:4]
                                //reg_clkph_sp0         0       : [11:8]
                                //reg_clkph_sp1         0       : [15:12]

    _RV32_2(0x16164a, 0x0002),  //reg_clkph_cmd         0       : [3:0]
                                //reg_clkph_dqsm        0       : [7:4]
                                //reg_clkph_sp0         0       : [11:8]
                                //reg_clkph_sp1         0       : [15:12]

    _RV32_2(0x161692, 0x0111),  // for U02 ECO delay line K/2 + offset
                                 //[3:0] reg_dline_sum0_0 = DLINE_SUM0_A0 (For DQ 7-0)
                                 //[3:0] reg_dline_sum1_0 = DLINE_SUM1_A0 (For DQ 15-8)
                                 //[3:0] reg_dline_sum0_1 = DLINE_SUM0_A1 (For DQ 23-16)
                                 //[3:0] reg_dline_sum1_1 = DLINE_SUM1_A1 (For DQ 31-24)
    _RV32_2(0x161690, 0x0003),
...
#if 1
    //DLL DQ deskew (low word)
    _RV32_2(0x1616a0, 0x5300),  //reg_dll0_3_deskew[3:0],  reg_dll0_2_deskew[3:0], //reg_dll0_1_deskew[3:0],  reg_dll0_0_deskew[3:0]
    _RV32_2(0x1616a2, 0x1303),  //reg_dll0_7_deskew[3:0],  reg_dll0_6_deskew[3:0], //reg_dll0_5_deskew[3:0],  reg_dll0_4_deskew[3:0]
    _RV32_2(0x1616a4, 0x2142),  //reg_dll0_11_deskew[3:0], reg_dll0_10_deskew[3:0],//reg_dll0_9_deskew[3:0],  reg_dll0_8_deskew[3:0]
    _RV32_2(0x1616a6, 0x2042),  //reg_dll0_15_deskew[3:0], reg_dll0_14_deskew[3:0],//reg_dll0_13_deskew[3:0], reg_dll0_12_deskew[3:0]

    //DLL DQ deskew (high word)
    _RV32_2(0x1616a8, 0x1111),  //reg_dll1_3_deskew[3:0],  reg_dll1_2_deskew[3:0], //reg_dll1_1_deskew[3:0],  reg_dll1_0_deskew[3:0]
    _RV32_2(0x1616aa, 0x1111),  //reg_dll1_7_deskew[3:0],  reg_dll1_6_deskew[3:0], //reg_dll1_5_deskew[3:0],  reg_dll1_4_deskew[3:0]
    _RV32_2(0x1616ac, 0x1111),  //reg_dll1_11_deskew[3:0], reg_dll1_10_deskew[3:0],//reg_dll1_9_deskew[3:0],  reg_dll1_8_deskew[3:0]
    _RV32_2(0x1616ae, 0x1111),  //reg_dll1_15_deskew[3:0], reg_dll1_14_deskew[3:0],//reg_dll1_13_deskew[3:0], reg_dll1_12_deskew[3:0]
#endif
    //RX DQSx Phase select
    _RV32_2(0x161670, 0x0000),  //[11]    : 'h   0 : dline_gated_control
    _RV32_2(0x16166c, 0x1717),  //[ 6: 0] : 'h   f : reg_dll0_ph //[14: 8] : 'h   f : reg_dll1_ph
    _RV32_2(0x16166e, 0x0F0F),  //[ 6: 0] : 'h   f : reg_dll2_ph //[14: 8] : 'h   f : reg_dll3_ph
    ...
    _RV32_2(0x161600, 0x2008),  //reg_pkg_sel      1   : [0]
                                //reg_odt_en       1   : [12:9]
    ...
    _RV32_2(0x161654, 0xC070),  //cmd_mode_sel = 2'h3
    ...
    _RV32_2(0x100604, 0x0051),  //reg_rd_timing		9	: [4:0] reg_1cmd_mode
    _RV32_2(0x100606, 0x1738),  //tREFRESH		2b	: [7:0] * 16
    _RV32_2(0x100608, 0x24EE),  //reg_tRCD		6	: [3:0]		11.25/1.875= 6
    _RV32_2(0x10060A, 0x3487),  //reg_tRRD	       	4 	: [3:0]	 10/1.875= 6  reg_tRTP(even) = 6
    _RV32_2(0x10060C, 0xC809),  //reg_tWL	 		5	: [3:0]	 CAS latency -1
    _RV32_2(0x10060E, 0xC117),  //tRFC			2a	: [7:0]		127.5/1.875= 68
    ...
    _RV32_2(0x161650, 0x1100),  //reg_cs0_skew          1       : [2:0]
                                //reg_cs1_skew          1       : [6:4]
                                //reg_cs2_skew          1       : [10:8]
                                //reg_cs3_skew          1       : [14:12]

    _RV32_1(0x161652, 0x68),
    ...
    _RV32_2(0x161692, 0x0111),  // DIV2-CAL setting
    _RV32_2(0x161690, 0x0003),
...
#if 1
    //DLL DQ deskew (low word)
    _RV32_2(0x1616a0, 0x0000),  //reg_dll0_3_deskew[3:0],  reg_dll0_2_deskew[3:0], //reg_dll0_1_deskew[3:0],  reg_dll0_0_deskew[3:0]
    _RV32_2(0x1616a2, 0x0000),  //reg_dll0_7_deskew[3:0],  reg_dll0_6_deskew[3:0], //reg_dll0_5_deskew[3:0],  reg_dll0_4_deskew[3:0]
    _RV32_2(0x1616a4, 0x0000),  //reg_dll0_11_deskew[3:0], reg_dll0_10_deskew[3:0],//reg_dll0_9_deskew[3:0],  reg_dll0_8_deskew[3:0]
    _RV32_2(0x1616a6, 0x0000),  //reg_dll0_15_deskew[3:0], reg_dll0_14_deskew[3:0],//reg_dll0_13_deskew[3:0], reg_dll0_12_deskew[3:0]

    //DLL DQ deskew (high word)
    _RV32_2(0x1616a8, 0x0000),  //reg_dll1_3_deskew[3:0],  reg_dll1_2_deskew[3:0], //reg_dll1_1_deskew[3:0],  reg_dll1_0_deskew[3:0]
    _RV32_2(0x1616aa, 0x0000),  //reg_dll1_7_deskew[3:0],  reg_dll1_6_deskew[3:0], //reg_dll1_5_deskew[3:0],  reg_dll1_4_deskew[3:0]
    _RV32_2(0x1616ac, 0x0000),  //reg_dll1_11_deskew[3:0], reg_dll1_10_deskew[3:0],//reg_dll1_9_deskew[3:0],  reg_dll1_8_deskew[3:0]
    _RV32_2(0x1616ae, 0x0000),  //reg_dll1_15_deskew[3:0], reg_dll1_14_deskew[3:0],//reg_dll1_13_deskew[3:0], reg_dll1_12_deskew[3:0]
#endif
    //RX DQSx Phase select
    _RV32_2(0x161670, 0x0000),  //[11]    : 'h   0 : dline_gated_control
    _RV32_2(0x16166c, 0x1111),  //[ 6: 0] : 'h   f : reg_dll0_ph //[14: 8] : 'h   f : reg_dll1_ph
    _RV32_2(0x16166e, 0x1111),  //[ 6: 0] : 'h   f : reg_dll2_ph //[14: 8] : 'h   f : reg_dll3_ph
    _RV32_2(0x161670, 0x0800),  //[11]    : 'h   1 : dline_gated_control
    ...
    _RV32_2(0x161660, 0x23C8),

    _END_OF_TBL32_,
#endif
};

#endif /* ENABLE_MSTAR_BD_MST189A_MX24 */
#endif /* __MIU_INIT_BD_MST189A_MX24_H__*/
