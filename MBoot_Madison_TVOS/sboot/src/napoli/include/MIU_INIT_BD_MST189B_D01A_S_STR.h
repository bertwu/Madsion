...
#ifndef __MIU_BD_MST189B_D01A_S_STR_H__
#define __MIU_BD_MST189B_D01A_S_STR_H__

#if (ENABLE_MSTAR_NAPOLI_BD_MST189B_D01A_S)
...
const MS_REG_INIT MIU0_DDR_Init_STR[] =
{
    ...
    _RV32_2(0x110d30, 0x3765),  //set pll to 780 MHz
    _RV32_2(0x110d32, 0x001E),  // DD3-1866 
    ...
    _RV32_2(0x101228, 0x40C0),  //reg_pack_en
    ...
    _RV32_2(0x110d48, 0x2244),  //reg_clkph_dq2         4       : [3:0]
                                //reg_clkph_dq3         4       : [7:4]
                                //reg_clkph_dqs2        0       : [11:8]
                                //reg_clkph_dqs3        0       : [15:12]

    _RV32_2(0x110d3a, 0x404A),  //reg_clkph_cmd         0       : [3:0]
                                //reg_clkph_dqsm        0       : [7:4]
                                //reg_clkph_sp0         0       : [11:8]
                                //reg_clkph_sp1         0       : [15:12]

    _RV32_2(0x110d4a, 0x608A),  //reg_clkph_cmd         0       : [3:0]
                                //reg_clkph_dqsm        0       : [7:4]
                                //reg_clkph_sp0         0       : [11:8]
                                //reg_clkph_sp1         0       : [15:12]
    _RV32_2(0x110d92, 0x9900),
    _RV32_2(0x110d90, 0x0003),
    //set (TX DQ/DQM phase)
    //set region
    _RV32_2(0x110d2e, 0x2300),  //reg_ddrpll2_region_sel_dq_l   2   :[14:12]
    ...
    _RV32_2(0x110da0, 0x2626),  //reg_dll0_3_deskew[3:0],  reg_dll0_2_deskew[3:0], //reg_dll0_1_deskew[3:0],  reg_dll0_0_deskew[3:0]
    _RV32_2(0x110da2, 0x3546),  //reg_dll0_7_deskew[3:0],  reg_dll0_6_deskew[3:0], //reg_dll0_5_deskew[3:0],  reg_dll0_4_deskew[3:0]
    _RV32_2(0x110da4, 0x2122),  //reg_dll0_11_deskew[3:0], reg_dll0_10_deskew[3:0],//reg_dll0_9_deskew[3:0],  reg_dll0_8_deskew[3:0]
    _RV32_2(0x110da6, 0x2120),  //reg_dll0_15_deskew[3:0], reg_dll0_14_deskew[3:0],//reg_dll0_13_deskew[3:0], reg_dll0_12_deskew[3:0]

    //DLL DQ deskew (high word)
    _RV32_2(0x110da8, 0x3515),  //reg_dll1_3_deskew[3:0],  reg_dll1_2_deskew[3:0], //reg_dll1_1_deskew[3:0],  reg_dll1_0_deskew[3:0]
    _RV32_2(0x110daa, 0x3535),  //reg_dll1_7_deskew[3:0],  reg_dll1_6_deskew[3:0], //reg_dll1_5_deskew[3:0],  reg_dll1_4_deskew[3:0]
    _RV32_2(0x110dac, 0x4142),  //reg_dll1_11_deskew[3:0], reg_dll1_10_deskew[3:0],//reg_dll1_9_deskew[3:0],  reg_dll1_8_deskew[3:0]
    _RV32_2(0x110dae, 0x2032),  //reg_dll1_15_deskew[3:0], reg_dll1_14_deskew[3:0],//reg_dll1_13_deskew[3:0], reg_dll1_12_deskew[3:0]
#endif

    //RX DQSx Phase select
    _RV32_2(0x110d70, 0x0000),  //[11]    : 'h   0 : dline_gated_control
    _RV32_2(0x110d6c, 0x0F0C),  //[ 6: 0] : 'h   f : reg_dll0_ph //[14: 8] : 'h   f : reg_dll1_ph
    _RV32_2(0x110d6e, 0x0C0D),  //[ 6: 0] : 'h   f : reg_dll2_ph //[14: 8] : 'h   f : reg_dll3_ph
    ...
    _RV32_2(0x110d5c, 0x7555),
    _RV32_2(0x110d5e, 0x7555),
...
const MS_REG_INIT MIU1_DDR_Init_STR[] =
{
    ...
    _RV32_2(0x161636, 0x6401),  //reg_DDRPLL_LOOP_DIV_FIRST : [15:14]   divide by 4
    _RV32_2(0x161634, 0x2004),  //reg_DDRPLL_LOOP_DIV_SECOND    : [15:14]   divide by 3
    _RV32_2(0x161630, 0x3765),  //set pll to 780 MHz
    ...
    _RV32_2(0x100628, 0x00c0),  //reg_pack_en
    ...
    _RV32_2(0x16163c, 0x1344),
    _RV32_2(0x16164c, 0x0044),
    ...
    _RV32_2(0x161648, 0x2244),  //reg_clkph_dq2         4       : [3:0]
                                //reg_clkph_dq3         4       : [7:4]
                                //reg_clkph_dqs2        0       : [11:8]
                                //reg_clkph_dqs3        0       : [15:12]

    _RV32_2(0x16163a, 0x404A),  //reg_clkph_cmd         0       : [3:0]
                                //reg_clkph_dqsm        0       : [7:4]
                                //reg_clkph_sp0         0       : [11:8]
                                //reg_clkph_sp1         0       : [15:12]

    _RV32_2(0x16164a, 0x404A),  //reg_clkph_cmd         0       : [3:0]
                                //reg_clkph_dqsm        0       : [7:4]
                                //reg_clkph_sp0         0       : [11:8]
                                //reg_clkph_sp1         0       : [15:12]
    _RV32_2(0x161692, 0x0044),
    _RV32_2(0x161690, 0x0003),
    
    //set (TX DQ/DQM phase)
    //set region
    _RV32_2(0x16162e, 0x2300),  //reg_ddrpll2_region_sel_dq_l   2   :[14:12]
                                //reg_ddrpll2_region_sel_dq_h   2   :[10:8]
                                //reg_ddrpll1_ictrl     0    [6:4]
                                //reg_ddrpll2_ictrl     0    [2:0]
...
#if 1
    //DLL DQ deskew (low word)
    _RV32_2(0x1616a0, 0x3501),  //reg_dll0_3_deskew[3:0],  reg_dll0_2_deskew[3:0], //reg_dll0_1_deskew[3:0],  reg_dll0_0_deskew[3:0]
    _RV32_2(0x1616a2, 0x3326),  //reg_dll0_7_deskew[3:0],  reg_dll0_6_deskew[3:0], //reg_dll0_5_deskew[3:0],  reg_dll0_4_deskew[3:0]
    _RV32_2(0x1616a4, 0x4364),  //reg_dll0_11_deskew[3:0], reg_dll0_10_deskew[3:0],//reg_dll0_9_deskew[3:0],  reg_dll0_8_deskew[3:0]
    _RV32_2(0x1616a6, 0x4043),  //reg_dll0_15_deskew[3:0], reg_dll0_14_deskew[3:0],//reg_dll0_13_deskew[3:0], reg_dll0_12_deskew[3:0]
    ...
    _RV32_2(0x16166c, 0x0F11),  //[ 6: 0] : 'h   f : reg_dll0_ph //[14: 8] : 'h   f : reg_dll1_ph
    ...
    _RV32_2(0x16165c, 0x5755),
    _RV32_2(0x16165e, 0x5755),
...
#endif /* ENABLE_MSTAR_BD_MST189B_D01A_S_STR */
#endif /* __MIU_INIT_BD_MST189B_D01A_S_STR_H__*/
