...
void BootRom_MiuDdr3Dqs(u8 u8MiuDev)
{
    ...
    MHal_MIU_WritReg16(MIU0_RIU_DTOP, 0xfe, 0x30e4);
    ...
    /* Set test length */
    MHal_MIU_WritReg16(MIU0_RIU_DTOP, 0xe4, 0x0024);
    ...
    MHal_MIU_WritReg16(u16RegMiuArb, 0x70, 0x0600);
    ...
    MHal_MIU_WritReg16(u16RegMiuAtop, 0x98, 0x0101);
    MHal_MIU_WritReg16(u16RegMiuAtop, 0x9a, 0x0101);
    MHal_MIU_WritReg16(u16RegMiuAtop, 0x90, 0xf0f1);
    
    delayus(10);

    MHal_MIU_WritReg16(u16RegMiuAtop, 0x90, 0xfff1);
    ...
    u16RegVal0 = MHal_MIU_ReadReg16(u16RegMiuArb, 0xc4);
    ...
    MHal_MIU_WritReg16(u16RegMiuAtop, 0x70, 0x0000);
    MHal_MIU_WritReg16(u16RegMiuAtop, 0x90, 0x0ff1);
    ...
    /* Disable SI mode */
    MHal_MIU_WritReg16(MIU0_RIU_DTOP, 0xfe, 0x38e4);
