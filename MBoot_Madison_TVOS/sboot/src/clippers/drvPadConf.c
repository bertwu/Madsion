...
//---------------------------------------------------------------------
    ...
    _RVM1(0x0e00, PAD_GPIO_PM0_OUT, BIT1),
    _RVM1(0x0e00, PAD_GPIO_PM0_OEN, BIT0),
    //default is GPIO
    #endif
    ...
    _RVM1(0x0e02, PAD_GPIO_PM1_OUT, BIT1),
    _RVM1(0x0e02, PAD_GPIO_PM1_OEN, BIT0),
    //default is GPIO
    #endif
    ...
    _RVM1(0x0e04, PAD_GPIO_PM2_OUT, BIT1),
    _RVM1(0x0e04, PAD_GPIO_PM2_OEN, BIT0),
    ...
    _RVM1(0x0e06, PAD_GPIO_PM3_OUT, BIT1),
    _RVM1(0x0e06, PAD_GPIO_PM3_OEN, BIT0),
    _RVM1(0x0e39, 0, BIT5 | BIT4 ),   //reg[0e39]#5 ~ #4 = 00b
    #endif
    ...
    _RVM1(0x0e08, PAD_GPIO_PM4_OUT, BIT1),
    _RVM1(0x0e08, PAD_GPIO_PM4_OEN, BIT0),
    //default is GPIO
    #endif
    ...
    _RVM1(0x0e0a, PAD_GPIO_PM5_OUT, BIT1),
    _RVM1(0x0e0a, PAD_GPIO_PM5_OEN, BIT0),
    ...
    _RVM1(0x0e0c, PAD_GPIO_PM6_OUT, BIT1),
    _RVM1(0x0e0c, PAD_GPIO_PM6_OEN, BIT0),
    ...
    _RVM1(0x0e0e, PAD_GPIO_PM7_OUT, BIT1),
    _RVM1(0x0e0e, PAD_GPIO_PM7_OEN, BIT0),
    ...
    _RVM1(0x0e10, PAD_GPIO_PM8_OUT, BIT1),
    _RVM1(0x0e10, PAD_GPIO_PM8_OEN, BIT0),
    //default is GPIO
    #endif
    ...
    _RVM1(0x0e12, PAD_GPIO_PM9_OUT, BIT1),
    _RVM1(0x0e12, PAD_GPIO_PM9_OEN, BIT0),
    ...
    _RVM1(0x0e30, PAD_PM_SPI_CK_OUT, BIT1),
    _RVM1(0x0e30, PAD_PM_SPI_CK_OEN, BIT0),
    //reg_spi_gpio
    ...
    _RVM1(0x0e34, PAD_PM_SPI_DO_OUT, BIT1),
    _RVM1(0x0e34, PAD_PM_SPI_DO_OEN, BIT0),
    //reg_spi_gpio
    _RVM1(0x0e6a, BIT0 , BIT0 ),   //reg[0e6a]#0 = 1
    #endif
    ...
    _RVM1(0x0e2e, PAD_PM_SPI_CZ_OUT, BIT1),
    _RVM1(0x0e2e, PAD_PM_SPI_CZ_OEN, BIT0),
    //reg_spicsz0_gpio
    ...
    _RVM1(0x0e32, PAD_PM_SPI_DI_OUT, BIT1),
    _RVM1(0x0e32, PAD_PM_SPI_DI_OEN, BIT0),
    //reg_spi_gpio
    _RVM1(0x0e6a, BIT0 , BIT0 ),   //reg[0e6a]#0 = 1
    #endif
    ...
    _RVM1(0x2e85, PAD_VID1_OUT, BIT1),
    _RVM1(0x2e85, PAD_VID1_OEN, BIT0),
    //reg_vid_is_gpio
    ...
    _RVM1(0x2e84, PAD_VID0_OUT, BIT1),
    _RVM1(0x2e84, PAD_VID0_OEN, BIT0),
    //reg_vid_is_gpio
    _RVM1(0x0e39, BIT2 , BIT2 ),   //reg[0e39]#2 = 1
    //reg_miic_mode[1:0]
    _RVM1(0x0e39, 0, BIT5 | BIT4 ),   //reg[0e39]#5 ~ #4 = 00b
    ...
    //reg_ld_spi3_config
    _RVM1(0x1eb4#2 = 0, 0, BIT2 ),   //reg[101eb4#2 = 0b
    #endif
...
//=================================================================================================
    ...
    _RVM1(0x0e21, BIT2, BIT2),          //Output Value of PM10
    _RVM1(0x0e1f, 0, BIT2),             //Output Enable of PM10
#elif (MS_BOARD_TYPE_SEL == BD_FPGA_CLIPPERS)
#else
